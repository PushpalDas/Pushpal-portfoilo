...
export default function CertificationsFilters({
    ...
    return (
        <section className="certifications-filters-section">
            <div className="certifications-filters-container">
                <div className="certifications-filters-row">
                            ...
                            <Magnetic key={f.key} strength={15}>
                                ...
                                >
                                    ...
                                    <span className="certifications-filter-btn-text">
                                        {f.label}
                                        {f.key !== 'all' && (
                                            <span className="certifications-filter-count">{counts[f.key]}</span>
                                        )}
                                    </span>
                                </button>
                            </Magnetic>
                    ...
                    <div className="certifications-filters-grid-row">
                        <Magnetic strength={20}>
                            <button
                                type="button"
                                className={`certifications-grid-btn${viewMode === 'rows' ? ' active' : ''}`}
                                onClick={() => setViewMode('rows')}
                                aria-label="Rows view"
                                title="List view"
                            >
                                <span className="certifications-grid-btn-fill" />
                                <span className="certifications-grid-btn-text">
                        ...
                        <Magnetic strength={20}>
                            <button
                                type="button"
                                className={`certifications-grid-btn${viewMode === 'grid-2' ? ' active' : ''}`}
                        ...
                        <Magnetic strength={20}>
                            <button
                                type="button"
                                className={`certifications-grid-btn${viewMode === 'grid-4' ? ' active' : ''}`}
