...
export default function CertificationsGrid({ items, gridColumns = 2 }: CertificationsGridProps) {
    ...
    return (
        <section className="certifications-grid-section" ref={gridRef}>
            <div className="certifications-grid-container">
                <ul className={`certifications-grid-items certifications-grid-${gridColumns}`}>
                    {items.map((item) => (
                        <li key={item.title} className="certifications-tile">
