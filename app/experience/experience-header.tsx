...
export default function ExperienceHeader({ filters, subtitle }: ExperienceHeaderProps) {
                ...
                <div className="experience-header-row">
                    <div className="experience-header-col">
                        ...
                        <p className="experience-header-subtitle">
                            {subtitle || "From 2022 to present - All my experience in one timeline"}
                        </p>
                    </div>
                    {filters && (
                        <div className="experience-header-filters">
                            {filters}
                        </div>
                    )}
                </div>
