...
export default function ContactPage() {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		window.open(`mailto:pushpaldas2001@gmail.com?subject=${subject}&body=${body}`, '_self');
	};
		...
		>
			<section ref={sectionRef} className="lc-page">
				...
				<div className="lc-hero">
					<h1 ref={headingRef} className={`lc-heading ${merryWeather.className}`}>
				...
				<div className="lc-content">
					...
					<form ref={formRef} className="lc-form" onSubmit={handleSubmit}>
						<div className="lc-form-header">
							...
							<p className="lc-form-desc">Fill out the form and I&apos;ll get back to you.</p>
						</div>
							...
							{SOCIALS.map((s) => (
								<Magnetic key={s.label} strength={20}>
									...
									>
										...
										<svg className="lc-social-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
											<path d="M7 17L17 7M17 7H7M17 7v10" />
										</svg>
									</a>
								</Magnetic>
				...
				<div ref={footerRef} className="lc-footer">
					...
					<div className="lc-footer-col">
						...
						<p className="lc-footer-value"><LocalTime /></p>
					</div>
				</div>
