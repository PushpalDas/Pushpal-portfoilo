...
export const workItems: WorkItem[] = [
	...
	},
	{
		...
		order: 16,
		outcome:
			'Built and never rolled out: drafts an offer range from dated comparator rows, every figure tracing to its source, and refuses the role when the rows are thin.',
	...
	},
	{
		...
		order: 4,
		outcome:
			'Built on made-up books and never rolled out: one book of accounts under six money flows, with watchers that point at problems they can prove and draft the fix while every approval stays a named person.',
