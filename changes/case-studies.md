...
Pushpal Das — full portfolio write-ups.

Generated from `data/case-studies-v2.json` · 35 case studies · 2026-08-25

## Contents

1. [Wi-R BAN — YR31](#1-wi-r-ban-yr31) — Ixana · 2024–present · Silicon
2. [Wi-R dev kits — BAN YR23 and NFE XA-NFE2001](#2-wi-r-dev-kits-ban-yr23-and-nfe-xa-nfe2001) — Ixana · 2024–2026 · Developer hardware
3. [Ixana-Wiki](#3-ixana-wiki) — Ixana · 2025 · Internal platform
4. [Dāsa — citation-grounded scripture retrieval](#4-d-sa-citation-grounded-scripture-retrieval) — ISKCON · 2026 · Applied AI
5. [Wi-R BAN — YR23](#5-wi-r-ban-yr23) — Ixana · 2024–present · Silicon
6. [NeuroAdapt — standardised spike-train features](#6-neuroadapt-standardised-spike-train-features) — IISc Bangalore · 2023–2026 · Research tooling
7. [Wi-R NFE — XA-NFE3001](#7-wi-r-nfe-xa-nfe3001) — Ixana · 2024–present · Silicon
8. [Wi-R NFE — XA-NFE2001](#8-wi-r-nfe-xa-nfe2001) — Ixana · 2024–2026 · Silicon
9. [Quantum gate simulator](#9-quantum-gate-simulator) — Personal · 2026 · Learning tools
10. [Procurement orchestrator](#10-procurement-orchestrator) — Ixana · 2026 · Procurement ops
...
18. [Video library and meeting recordings](#18-video-library-and-meeting-recordings) — Ixana · 2026 · Meeting intelligence
19. [Calendar sync across two tenants](#19-calendar-sync-across-two-tenants) — Ixana · 2025 · Workplace automation
20. [AI product planning operating system](#20-ai-product-planning-operating-system) — Ixana · 2026 · Planning tooling
21. [AI Lawyer — patent drafting foundation](#21-ai-lawyer-patent-drafting-foundation) — Ixana · 2026 · Legal tooling
22. [Reporting and Gantt dashboard](#22-reporting-and-gantt-dashboard) — Ixana · 2026 · PM tooling
23. [Patent program operations](#23-patent-program-operations) — Ixana · 2024–2026 · Patent operations
24. [Patent dashboard sync](#24-patent-dashboard-sync) — Ixana · 2025 · Portfolio ops
...
32. [Triple riding avoidance](#32-triple-riding-avoidance) — Ricky Kids · 2022 · Road safety
33. [Toys for autistic kids](#33-toys-for-autistic-kids) — Ricky Kids · 2021–2023 · Assistive play
34. [Sludge-traversing ROV](#34-sludge-traversing-rov) — Ricky Kids · 2022 · Field robotics
35. [ENVI-City — sustainable smart city concept](#35-envi-city-sustainable-smart-city-concept) — Ricky Kids · 2022 · Urban concept

---

## 1. Wi-R BAN — YR31

*Ixana · 2024–present · Silicon*

**The second spin: four times the rate and a fifth of the latency, bought with a deliberate step backwards on energy per bit.**
...
**Evidence:** [Wi-R BAN product page (carries the YR31 specification)](https://www.ixana.ai/products/chips/wi-r-ban)
...
*Chart: `hbar` · unit Mbit/s*

| Item | Value |
| --- | --- |
| Wi-Fi | 100 — and a radio budget a head-worn design cannot carry · value: 100 |
| Wi-R BAN — YR31 | 20 Mbit/s at under 6 mW · value: 20 |
| Ultra-wideband | 10 — broadcast, and an order more energy per bit · value: 10 |
| Wi-R BAN — YR23 | 5 — the ceiling that forced compression · value: 5 |
| Bluetooth LE | 2 — not a video link · value: 2 |

> What a head-worn video design could choose from, Apr 2024, from published figures for each link. Rate alone does not decide it — Wi-Fi wins the axis and loses the product, because a design that must run all day cannot carry the radio. Gen-2's job was to clear the video bar without leaving the power class that made Wi-R the answer at all.
...
*Chart: `dotplot` · unit evaluations unblocked*

| Item | Value |
| --- | --- |
| On-die trim storage | value: 17 · n: 6 |
| Higher rate mode | value: 9 · n: 14 |
| Test-time reduction | value: 6 · n: 4 |
| Package variant | value: 4 · n: 9 |
| Backward-compat energy mode | value: 3 · n: 11 |
| Convenience requests (28) | value: 2 · n: 22 |
...
- *Shipped:* Up to 20 Mbit/s with sub-0.2 ms latency; On-die per-unit trim storage; Reduced ATE test program; Same 16-device network and range envelope; Interop parity with the installed YR23 host base
- *Deferred:* Smaller package variant; Multi-network coexistence; Field-updatable PHY parameters
- *Cut:* Backward-compatible gen-1 energy mode; Second host interface option; On-die link encryption
...
**Screen — Wi-R BAN YR31 transceiver package**

![Wi-R BAN YR31 transceiver package](/static/images/project/wi-r-ban-yr31-package.png)
...
> Ixana YR31 package, from Ixana's published product photography. The package, part marking and specification are public; internal design detail is not shown. Happy to walk through the real programme in a conversation.
...
| Metric | Value |
| --- | --- |
| Link rate, gen-1 to gen-2 | 5 → 20 (Mbit/s) |
| Median board bring-up to a stable on-body link | 11 d → 2 d |
| Wafer yield at production release | 71% → 86% |
| ATE test time at volume | 4.2 s → 2.6 s (per unit) |
| Energy per bit, traded deliberately for rate | 0.12 → 0.20 (nJ/bit) |
| Interop across the installed host base (guardrail) | 94% (parity with YR23) |
...
*Chart: `diverging` · unit %*

| Item | Value |
| --- | --- |
| Bring-up time | −82% · value: -82 · good: true |
| Link latency | −80% · value: -80 · good: true |
| ATE test time | −38% · value: -38 · good: true |
| Wafer yield | +21% · value: 21 · good: true |
| Energy per bit | +67% — intended · value: 67 · good: false |
...
**Evidence:** [Dev kits product page](https://www.ixana.ai/products/dev-kits) · [Wi-R BAN datasheet page](https://www.ixana.ai/products/chips/wi-r-ban) · [Wi-R NFE datasheet page](https://www.ixana.ai/products/chips/wi-r-nfe)
...
*Chart: `hbar` · unit evals / quarter*

| Item | Value |
| --- | --- |
| Dev kit | 12 per quarter · value: 12 |
...
*Chart: `hbar` · unit days*

| Item | Value |
| --- | --- |
| Evaluation 1 | 49 days · value: 49 |
| Evaluation 2 | 38 days · value: 38 |
| Evaluation 3 | 31 days · value: 31 |
| Evaluation 4 | 26 days · value: 26 |
| Evaluation 5 | 22 days · value: 22 |
| Evaluation 6 | 18 days · value: 18 |

> Time to first link, six partner evaluations, Mar 2023 – Feb 2024, measured from our shipping records and their onboarding notes. The downward trend is us getting better at hand-holding, not them getting better at bring-up — which is exactly the cost the kit had to remove.
...
- *Shipped:* BAN and NFE transceiver modules; Known-good host board; Dry and gel electrode pairs; USB console with a link-health readout; Two worked example applications
- *Deferred:* Second host board option; Android companion app; Multi-node topology examples
- *Cut:* On-kit display; User-adjustable electrode mounting; Battery-powered untethered mode
...
**From the kit definition — scope, rev D**

*Out of scope for the first kit revision*
...
> One page from the kit definition, with supplier and cost lines removed.
...
**Screen — Wi-R dev kit enclosure showing the sensor port, module bay and power control**

![Wi-R dev kit enclosure showing the sensor port, module bay and power control](/static/images/project/Image__10_.jpg)
...
> Ixana dev kit enclosure, photographed in-house. The mechanical design and markings are public; internal boards are not shown. Happy to walk through a live bring-up in a conversation.
...
| Kits returned under RMA (guardrail) | 3.2% |
...
- Points: Q3 24 4, Q4 24 13, Q1 25 24, Q2 25 38, Q3 25 52, Q4 25 62
...
> **Note.** This is a sample portfolio page about real silicon. Part numbers, package photography and product pages are public and linked above; kit volumes, design-in counts, support figures and timings are invented placeholders and should be replaced with real data before this page is used. Schematics, test reports and partner names are not shown. I'm glad to walk through the real program and its numbers in a conversation.

---

## 3. Ixana-Wiki

*Ixana · 2025 · Internal platform*

**One place to find every document, meeting, task and patent record — instead of five tools and a colleague who might remember.**
...
**Evidence:** [Repository](https://github.com/PushpalDas/Ixana-Wiki)
...
*Chart: `hbar` · unit h / mo*

| Item | Value |
| --- | --- |
| Knowledge search | 340 h / mo · value: 340 |
| Onboarding docs | 90 h / mo · value: 90 |
| Meeting notes | 60 h / mo · value: 60 |

> Opportunity sizing across three candidate problems. Estimated from a two-week diary study (n=9) plus calendar sampling. Knowledge search was roughly four times the next-largest problem, which is why it won the half.
...
*Chart: `hbar` · unit of 14*

| Item | Value |
| --- | --- |
| Started with a guess | 11 / 14 · value: 11 |
| Searched 3+ tools | 12 / 14 · value: 12 |
| Asked a colleague | 9 / 14 · value: 9 |
| Recreated a document | 6 / 14 · value: 6 |

> Behaviours observed across 14 interviews. Nearly half had recreated a document that already existed — the loop that made the problem compound.
...
- *Shipped:* Search across 5 sources; AI answers with citations; Azure AD sign-in; Secure file preview; Transcript timestamp jump
- *Deferred:* Slack and email sources; Saved searches; Usage analytics v2
- *Cut:* Per-document permissions; Multi-language search; Public-facing mode
...
> One page from the working PRD, with internal locations and dates generalised.
...
**Screen — Chat answer view, recreated in Figma — with numbered callout arrows drawn on top**

- **Citations sit inline, not in a footer.** In the alpha, people wouldn't act on an answer without seeing the source first — inline citations moved it from a demo to a daily tool.
...
- **Transcript cues are timestamps, not text.** Nobody read transcripts — they jumped to the moment and listened.

> Recreated from the production interface. Layout and interactions are accurate; all documents, queries and results shown are invented. Happy to walk through the real product in a conversation.
...
| Metric | Value |
| --- | --- |
| Employees active in first quarter | 118 (of 140) |
| Searches per week by month 3 | 340 |
| Median time to find a document | 9m → 55s |
| Answers rated useful in-product | 78% |
| Systems unified into one index | 5 |
| Duplicate docs created (guardrail) | −61% |
...
> Weekly active users after launch, Jun–Aug 2025, from the application database. Growth was steady rather than spiked — no company-wide mandate, so adoption spread department by department, and it crossed the pre-agreed floor in week six.
...
> **Note.** This is an internal product. Screens are recreations with invented content, and figures are anonymised or expressed as relative change. I'm glad to walk through the real system and the underlying numbers in a conversation.

---

## 4. Dāsa — citation-grounded scripture retrieval

*ISKCON · 2026 · Applied AI*

**An engine that answers with a teacher's actual cited words, or says plainly that it has no teaching on the subject.**
...
**Evidence:** [Product walkthrough](https://www.youtube.com/watch?v=S4G_99Yn2M4)
...
*Chart: `hbar` · unit of 40 out-of-scope questions*

| Item | Value |
| --- | --- |
| Retrieval with a distance gate | 37 / 40 refused correctly · value: 37 |
| Hand-curated answer library | 40 / 40, but 200 questions total · value: 40 |
| Fine-tuned model | 6 / 40 refused correctly · value: 6 |

> Approach comparison, Jun 2026, on 40 deliberately out-of-scope questions. The fine-tuned model answered nearly all of them in a convincing voice, which is exactly the behaviour that makes it unusable here. The curated library refuses perfectly and cannot scale past a few hundred questions.
...
**Screen — Answer view with an inline citation and a refusal example beside it, recreated in Figma — with numbered callout arrows drawn on top**
...
> Recreated interface. Layout is accurate; the question, answer and citation shown are illustrative. Happy to walk through the real engine in a conversation.
...
| Item | Value |
| --- | --- |
| Philosophy | value: 0.93 · n: 24 |
| Practice | value: 0.88 · n: 21 |
| Scripture reference | value: 0.86 · n: 18 |
| Death and afterlife | value: 0.79 · n: 14 |
| Guru and guidance | value: 0.76 · n: 12 |
| Grief | value: 0.71 · n: 11 |

- Threshold: value 0.75, label 0.75 line

> nDCG@6 by question category after re-ranking, n=100 total split as shown, judged independently by three reviewers, Aug 2026. The aggregate figure of 0.840 hides the finding: emotional questions retrieve worst and are the ones people most need answered, which is where the next work goes.

| Metric | Value |
| --- | --- |
| Retrieval quality, nDCG@6 after re-ranking | 0.614 → 0.840 (n=100) |
| Fabricated citations per 100 answers | 17 → 0 |
| Out-of-scope questions correctly refused (guardrail) | 37 (of 40) |
| Users; engine and interface are not yet connected | 0 |
...
> **Note.** This is a volunteer research project over published texts. The interface described in section 04 is a recreation, and all evaluation figures on this page are invented placeholders for this sample. I'm glad to walk through the real engine and its evaluation in a conversation.
...
**The first Wi-R body-area part a partner could design in rather than admire — 0.12 nJ/bit at 5 Mbit/s, into production without a respin.**
...
**Evidence:** [Wi-R BAN product page](https://www.ixana.ai/products/chips/wi-r-ban) · [Wi-R technology white paper](https://www.ixana.ai/blog/wi-r-technology-white-paper)
...
*Chart: `hbar` · unit × Wi-R BAN*

| Item | Value |
| --- | --- |
| Wi-Fi / Bluetooth LE | 83× — about 10 nJ/bit · value: 83 |
| Ultra-wideband | 8× — about 1 nJ/bit · value: 8 |
| Wi-R BAN (YR23) | 1× — 0.12 nJ/bit at 5 Mbit/s · value: 1 |

> Energy per bit across the links these segments were choosing between, expressed as a multiple of YR23. Alternative figures are Ixana's published comparison; the YR23 figure is from the public specification. Plotted as a ratio because on an absolute axis the Wi-R bar is invisible — which is the argument, but not a readable chart.
...
- *Shipped:* 100 kbit/s – 5 Mbit/s ladder, fully characterised; Up to 16 devices per on-body network; Sub-1 ms link latency; Host interface with a reference driver; Characterised electrode interface and trim procedure
- *Deferred:* Higher-rate mode (became YR31); On-die per-unit trim storage; Multi-network coexistence
- *Cut:* On-die link encryption; Second host interface option; Field-updatable PHY parameters
...
**Screen — Wi-R BAN YR23 transceiver package**

![Wi-R BAN YR23 transceiver package](/static/images/project/wi-r-ban-yr23-package.png)
...
> Ixana YR23 package, from Ixana's published product photography. The package, part marking and full specification are public; internal design detail is not shown. Happy to walk through the real program in a conversation.

![image](/static/images/project/wi-r-ban-yr23-network-topology.png)

> **** The network YR23 serves — up to 16 devices on one body, from head-worn to foot, linked along the surface rather than through the air. Range along the body is 10–15 m; off the body it stops at roughly 0.1 m, which is what makes the link private without encryption.
...
| Metric | Value |
| --- | --- |
| Energy per bit delivered on first silicon | 0.12 (nJ/bit @ 5 Mbit/s) |
| Die revisions between first silicon and production | 0 (respins) |
...
- Cutoff: value 80, label 80% of escapes
...
> **Note.** This is a sample portfolio page about real silicon. The part number, package photography and full specification are public and linked above. Program figures — schedule, escape counts, design-ins, interop results, team shape — are invented placeholders and should be replaced with real data before this page is used. No schematic, test report or customer name is shown. I'm glad to walk through the real program and its numbers in a conversation.

---

## 6. NeuroAdapt — standardised spike-train features

*IISc Bangalore · 2023–2026 · Research tooling*

**Replaced ad-hoc analysis scripts with one defined feature set, so two labs computing burst index finally mean the same thing.**
...
> **Confidentiality.** Academic collaboration. The validation figures on this page are invented placeholders for this sample; no unpublished recording or collaborator result is shown.
...
- **Result.** On simulated data with known ground truth the pipeline recovered the planted structure: 87% of population variance in two principal components, a peak cross-correlation of 0.85 for the synchronous pair, and 102 coincident spike pairs at zero lag. What it has not shown is anything about real recordings.
...
**Figure — Of 22 audited published analyses: 19 used a private script, 14 could not be reproduced from the paper alone, 11 reported a metric under a name used differently elsewhere, 4 published their code**  
*Chart: `hbar` · unit of 22 analyses*

| Item | Value |
| --- | --- |
| Analysis in a private script | 19 / 22 · value: 19 |
| Not reproducible from the paper | 14 / 22 · value: 14 |
...
**Screen — Generated report page showing unit metrics and the population projection, recreated with simulated data — with numbered callout arrows drawn on top**

- **Every metric prints its definition beside its value.** This is the whole intervention. A burst index without its definition is exactly the artefact the audit found 11 times.
- **Unit and population sections are visually separate.** They have different reliability and different assumptions, and merging them invites reading a population claim as a unit-level one.
- **Preprocessing choices are listed, not implied.** 14 of 22 audited analyses were irreproducible because of omitted preprocessing, so the report states it whether or not anyone reads it.
- **Figures are generated from the stored features, not raw data.** It guarantees the figure and the table cannot disagree, a failure we hit twice during development.

> Recreated report page. Structure is accurate; all values shown come from simulated data. Happy to walk through the real module in a conversation.

### 05 — Finding and what it changed

We agreed before running anything that the pipeline failed unless it recovered all three planted structures — a synchronous pair, a bursty population and a regular one — with the top two components carrying at least 80% of variance. Definitional drift was the guardrail: any metric shipped without a written definition in the output would reproduce the problem we were fixing, and that count has stayed at zero.

**Figure — Population projection onto the first two principal components, showing the bursty and regular populations separating into two clusters**  
*Chart: `scatter` · x: PC1 — 61% of variance · y: PC2 — 26%*
...
> Population projection on simulated data, n=16 units across two planted populations, Feb 2026. The first two components carry 87% of the variance and separate the bursty units from the regular ones — the result the simulation was constructed to produce, and therefore a check that the pipeline works rather than a discovery about neurons.

| Metric | Value |
| --- | --- |
| Population variance in the first two components | 87% (bar was 80%) |
| Peak cross-correlation, planted synchronous pair | 0.85 |
| Coincident spike pairs detected at zero lag | 102 |
| Metrics shipped without a written definition (guardrail) | 0 |
...
`Module configuration — unit-level metrics: firing rate, ISI coefficient of variation, burst index, Fano factor · population-level: pairwise cross-correlation, synchrony index, PCA · outputs to a standard neuroscience container plus CSV and JSON · report figures interpreted by gpt-4o-mini · reports indexed in Weaviate with text-embedding-3-large`
...
> **Note.** This is academic research validated on simulated data. The report described in section 04 is a recreation, and all figures on this page are invented placeholders for this sample. No unpublished recording or collaborator result is shown. I'm glad to walk through the real module and its validation in a conversation.

---

## 7. Wi-R NFE — XA-NFE3001

*Ixana · 2024–present · Silicon*

**A gen-2 the pipeline asked for: 13.5 Mbit/s of real throughput, which is what turns a sealed enclosure into a service port instead of a demo.**
...
**Evidence:** [Wi-R NFE product page](https://www.ixana.ai/products/chips/wi-r-nfe) · [XA-NFE3001 announcement](https://www.ixana.ai/blog/xa-nfe3001-20mbps-near-field-electric)
...
*Chart: `hbar` · unit k units / year*

| Item | Value |
| --- | --- |
| Stalled pipeline (14 evals) | 480k — named in their own requirement sheets · value: 480 |
| Gen-1 consumer derivative | 200k — our estimate, no committed volume · value: 200 |
| Gen-1 sockets shipping | 90k — the base to protect · value: 90 |

> Opportunity sizing, Feb 2025. The top bar is not our forecast — it is the sum of volumes partners wrote into their own requirement sheets, which is a different quality of number from the middle bar. That asymmetry, not the size of the gap, decided the year.
...
| Item | Value |
| --- | --- |
| Goodput (Mbit/s) | 3.4 vs 10 · value: 3.4 · target: 10 · max: 15 · targetLabel: required · pass: false |
| 100 MB transfer | 235 s vs 60 s · value: 235 · target: 60 · max: 250 · targetLabel: required · pass: false |
| 50 MB transfer | 118 s vs 30 s · value: 118 · target: 30 · max: 250 · targetLabel: required · pass: false |
| Latency (ms) | 0.9 vs 1.0 · value: 0.9 · target: 1 · max: 2 · targetLabel: required · pass: true |
...
- *Shipped:* 20 Mbit/s PHY, about 13.5 Mbit/s real throughput; Sub-0.2 ms latency; 1–15 cm operating range; Under 6 mW active at full rate; Host interface and reference driver shared with gen-1
- *Deferred:* Second host interface option; Per-profile power tuning exposed to the host; Reduced-rate low-power bin
- *Cut:* Operation through fully conductive enclosures; On-die presence classification; Runtime-adjustable range
...
**Screen — Wi-R NFE XA-NFE3001 transceiver package**

![Wi-R NFE XA-NFE3001 transceiver package](/static/images/project/wi-r-nfe-xa-nfe3001-package.png)
...
> Ixana XA-NFE3001 package, from Ixana's published product photography. The package, part marking and specification are public; internal design detail is not shown. Happy to walk through the real programme in a conversation.

![image](/static/images/project/wi-r-nfe-xa-nfe3001-sealed-transfer.png)

> **** The workflow the part exists for — a handheld against a sealed enclosure, moving a firmware image and pulling logs back without a connector. The enclosure stays closed, which is the commercial argument; throughput is what makes it a workflow rather than a demonstration.
...
*Chart: `thresholdCurves`*

- *XA-NFE2001 (gen-1)* — 59, 118, 235
- *XA-NFE3001 (gen-2)* — 15, 30, 59

- Threshold: value 60, label 60 s window
...
> **Note.** This is a sample portfolio page about real silicon. The part, its specification, throughput figures and application framing are public and linked above. Pipeline figures — stalled-evaluation counts, conversion, requirement sheets, socket retention and volumes — are invented placeholders and should be replaced with real data before this page is used. No schematic, test report or customer name is shown. I'm glad to walk through the real programme and its numbers in a conversation.

---

## 8. Wi-R NFE — XA-NFE2001

*Ixana · 2024–2026 · Silicon*

**The second product line: a touch-range electric-field link at 5 Mbit/s under a milliwatt, sold against NFC rather than against Bluetooth.**
...
**Evidence:** [Wi-R NFE product page](https://www.ixana.ai/products/chips/wi-r-nfe) · [XA-NFE2001 launch announcement](https://www.ixana.ai/news/ixana-launches-wi-r-nfe) · [Technical paper (arXiv)](https://arxiv.org/pdf/2512.07167)
...
| Column | Link setup | Payload transfer |
| --- | --- | --- |
| Bluetooth LE | 12 | 23 |
| NFC | 1 | 64 |
| Wi-R NFE | 1 | 7 |

> Seconds to move a 4 MB firmware image between two handheld devices, Dec 2023. Transfer times computed from published throughput — NFE at 5 Mbit/s, NFC at roughly a tenth of that per Ixana's launch comparison, BLE at practical 2M-PHY rates. Setup times are our bench estimates, and they are the half buyers underrate: NFC is instant to establish and slow to finish, BLE is the reverse, and only one column is good at both.
...
*Chart: `hbar` · unit of 96 requests*

| Item | Value |
| --- | --- |
| Device-to-device, not body-worn | 54 / 96 · value: 54 |
| Explicitly "a faster NFC" | 22 / 96 · value: 22 |
| Needed off-body range | 19 / 96 · value: 19 |
...
- *Shipped:* 5 Mbit/s at under 1 mW; Three characterised range profiles from 5 to 25 cm; Sub-millisecond end-to-end latency; RF-silent electric-field coupling; Reference driver and provisioning flow shared with BAN
- *Deferred:* Higher-rate mode (became XA-NFE3001); Multi-device near-field grouping; Second host interface option
- *Cut:* Runtime-adjustable range; On-die presence classification; Per-profile power tuning exposed to the host
...
**Screen — Wi-R NFE XA-NFE2001 transceiver package**

![Wi-R NFE XA-NFE2001 transceiver package](/static/images/project/wi-r-nfe-xa-nfe2001-package.png)
...
> Ixana XA-NFE2001 package, from Ixana's published product photography. The package, part marking and full specification are public; internal design detail is not shown. Happy to walk through the real program in a conversation.

![image](/static/images/project/wi-r-nfe-xa-nfe2001-coupling-model.png)

> **** The NFE link modelled as a four-node capacitive network, from Ixana's published technical material. Differential and asymmetric coupling are the two regimes the three range profiles sit in — and the reason range is a design-time characterisation rather than a register a host can write.
...
| Metric | Value |
| --- | --- |
| Energy efficiency per bit at 5 Mbit/s | 50× (vs NFC) |
| Sample requests fulfilled in the launch quarter | 88 of 104 |
| NFE evaluations that reached a design-in | 7 of 26 |
| Interop pass rate, host platform × range profile | 91% (of 12 configs) |
| Median end-to-end latency on partner hardware | 0.6 ms |
| BAN milestones missed while the second line spun up (guardrail) | 0 |
...
> **Note.** This is a sample portfolio page about real silicon. The part number, specification, launch announcement and NFC comparison claims are public and linked above. Program figures — schedule, sample fulfilment, design-ins, interop results, team load — are invented placeholders and should be replaced with real data before this page is used. No schematic, test report or customer name is shown. I'm glad to walk through the real program and its numbers in a conversation.

---

## 9. Quantum gate simulator

*Personal · 2026 · Learning tools*

**A working 10-qubit circuit builder with live Bloch-sphere rendering, built to make state evolution visible — and never put in front of a learner.**
...
*Chart: `hbar` · unit states per 20 min*

| Item | Value |
| --- | --- |
| Interactive simulator | 40+ · value: 42 |
| Annotated notebook | 12 · value: 12 |
| Static diagram set | 6 · value: 6 |

> Sizing, Dec 2025, by timing each format against the same set of exercises. The notebook figure is generous — it assumes the learner edits and re-runs cells rather than reading, which about a third of observed learners did not do.
...
**Screen — Circuit grid with three Bloch spheres mid-entanglement, recreated in Figma — with numbered callout arrows drawn on top**
...
> Recreated interface. Layout is accurate; the circuit shown is invented. Happy to walk through the real prototype in a conversation.
...
- Points (ms): 4 4, 6 15, 8 62, 9 121, 10 244, 11 610, 12 1420

- Ceiling: value 200, label 200 ms interactivity budget

> Measured computation time by qubit count, Jun 2026, median of 20 runs per point on the deployed engine. The ten-qubit cap was chosen before this was measured and sits just past the budget line — the guess was close and slightly optimistic, and eleven qubits would have quietly broken the premise.

| Metric | Value |
| --- | --- |
| Qubit ceiling, chosen to protect interactivity | 10 |
| State vector time at the ceiling | 244ms (budget 200ms) |
| Physics tests passing (guardrail) | 32 |
| Learners; it was never released | 0 |
...
> **Note.** This is a personal prototype that was never released to learners. The interface described in section 04 is a recreation, and the usage figures on this page are invented placeholders for this sample. I'm glad to walk through the real prototype in a conversation.

---

## 10. Procurement orchestrator

*Ixana · 2026 · Procurement ops*

**A pilot that names one accountable owner within a business day, so requesters stop chasing procurement for a status nobody holds.**
...
*Chart: `hbar` · unit weeks to first request*

| Item | Value |
| --- | --- |
| Lean pilot on existing tooling | 5 weeks · value: 5 |
| Extend the finance system | 14 weeks · value: 14 |
| Buy a procurement platform | 26 weeks plus licensing · value: 26 |

> Options sizing, Mar 2026, estimated with the platform administrator and the finance systems owner. At fewer than ten requests a week the lean option is not a compromise — it is proportionate, and the only one that tests the operating model before committing to a platform.
...
*Chart: `hbar` · unit of 63 threads*

| Item | Value |
| --- | --- |
| No acknowledgement at all | 51 / 63 · value: 51 |
| Owner unclear throughout | 34 / 63 · value: 34 |
| No recorded approval | 22 / 63 · value: 22 |
| Tracked in a private spreadsheet | 9 / 63 · value: 9 |

> Thread analysis of 63 completed requests, Oct 2025 – Mar 2026, coded from the email record. The last bar predicts failure: nine people had already built their own tracking, and a pilot that does not beat a private spreadsheet will be ignored by exactly those people.
...
- *Shipped:* Canonical request list with a submission form; Routing and approver maps; One financial approval stage; Reminders, escalation and ageing views; Daily integrity check with an exceptions log
- *Deferred:* Supplier catalogue integration; Multi-currency handling; Requester-visible spend reporting
- *Cut:* Services and software requests; Multi-stage approval chains; Automated supplier selection
...
**From the pilot specification — launch gates, v1.2**

*The pilot does not exit to production unless all of the following hold*
...
> One page from the pilot specification. Organisation names and approver thresholds removed.
...
**Screen — Requester view of a single request showing owner, next action and verified ETA, recreated in Figma — with numbered callout arrows drawn on top**
...
> Recreated from the pilot interface. Layout and fields are accurate; all requests, suppliers, prices and names shown are invented. Happy to walk through the real pilot in a conversation.
...
| Metric | Value |
| --- | --- |
| Pilot requests completed so far (n for all figures) | 23 |
| Assigned to a named owner within one business day | 21 (of 23) |
| Ordered without a recorded approval | 0 (of 23) |
| Median time from submission to a named owner | 3.6d → 0.6d |
| Requesters who still chased by email | 2 (of 23) |
| Silent flow failure, caught by the daily check (guardrail) | 1 |
...
| Item | Value |
| --- | --- |
| Assigned within 1 business day | 21 of 23 · value: 21 · target: 23 · max: 25 · targetLabel: gate: 23 · pass: false |
| Ordered with valid approval | 23 of 23 · value: 23 · target: 23 · max: 25 · targetLabel: gate: 23 · pass: true |
| Failures resolved within 1 day | 1 of 1 · value: 1 · target: 1 · max: 25 · targetLabel: gate: all · pass: true |
| Completed pilot requests | 23 · value: 23 · target: 20 · max: 25 · targetLabel: floor: 20 · pass: true |

> Performance against the four launch gates, Apr–Aug 2026, n=23. Three gates hold and one does not: two requests took more than a business day to assign, both submitted on a Friday afternoon into an organisation whose approver map had a gap. The gate is failing for a specific and fixable reason, which is the most useful state for a gate to be in.
...
> **Note.** This is an internal pilot. The screen described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample — every one is quoted against its sample size because a pilot this small cannot support a rate. No supplier, price or requester is shown. I'm glad to walk through the real pilot and its gates in a conversation.

---

## 11. WishKey — Key Management System

*EEGRAB · 2023 · Access control*

**An electronic key cabinet that makes a key impossible to take anonymously, replacing a paper register nobody could reconcile.**
...
**Evidence:** [WishKey brochure — EEGRAB](https://eegrab.com/wp-content/uploads/2021/brochure/Wishkey_brochure.pdf) · [WishKey product demo — EEGRAB](https://www.youtube.com/watch?v=8etIl_0wj0I)
...
*Chart: `hbar` · unit % of key-removal events*

| Item | Value |
| --- | --- |
| Electronic cabinet, per-slot locking | 96% — the record is a side effect of taking the key · value: 96 |
| Key module on the door access system | 41% — names who entered the room, not which key left · value: 41 |
| Tablet logbook at the guard desk | 23% — still voluntary, just faster to skip · value: 23 |

> Options scored against the register audit in section 02, Q1 2023. The door-access option scores as well as it does only because entry and key-taking usually coincide; when they do not, it is silently wrong, which is worse than being absent.
...
> Six pilot sites, Q1 2023, as a share of all register rows. The right-hand bar is the finding that mattered: for roughly one row in twelve the register never closed, so nobody could say whether the key was in a drawer, in a van, or gone. Managers guessed a drawer.
...
- *Shipped:* RFID card plus PIN at the cabinet; Per-slot electromagnetic locking with feedback; Smart key tags with one-time anti-smash seals; On-cabinet audit log and printed reports; Operator terminal with multi-language support; Wall or desk mounting
- *Deferred:* Directory and single-sign-on synchronisation; Email and SMS notification; Multi-cabinet central server
- *Cut:* Fingerprint authentication; Photo capture on every release; Remote unlock from the server
...
**Screen — Bare WishKey slot controller board: sixteen EMLOCK connectors and FET drivers down the left edge, four optocouplers, sixteen RFID reader connectors on the right, and Arduino Mega-form headers across the middle**

![Bare WishKey slot controller board: sixteen EMLOCK connectors and FET drivers down the left edge, four optocouplers, sixteen RFID reader connectors on the right, and Arduino Mega-form headers across the middle](/static/images/project/eegrab-wishkey-controller-board.jpg)
...
> My own photograph of a bare slot controller board, before assembly, with the EEGRAB silkscreen visible. No customer site, key list or configuration is shown. Happy to walk through the assembled cabinet in a conversation.

![image](/static/images/project/eegrab-wishkey-pcb-3d-view.png)

> **** The same slot board in the layout tool. Lock connectors run down one edge and reader connectors down the other, deliberately opposite each other, so the 12 V drive harness and the reader bus run up separate sides of the cabinet instead of crossing behind the slots.
...
| Metric | Value |
| --- | --- |
| Keys under management across deployed sites | 3,400+ |
| Cabinets in service | 22 (across 9 sites) |
| Median time to draw a key, register vs cabinet | 4 min → 15 s |
| Unattributed key removals (guardrail) | 0.3% (of removal events) |
| Emergency mechanical overrides used | 2.1 (per 1,000 draws) |
| Commissioning time per cabinet | 1 day → 2 h |
...
| Column | Returned on time, attributed | Returned late, attributed | Escalated to a supervisor before release | Emergency override or unattributed |
| --- | --- | --- | --- | --- |
| Data-centre halls (1,450 keys) | 86.1 | 9 | 4.5 | 0.4 |
| Manufacturing plants (1,150 keys) | 74 | 18 | 7.4 | 0.6 |
...
> **Note.** Sample portfolio page. Every figure here is invented and reconciled to be internally consistent — deployment counts, audit rates, timings, and the evidence counts in section 02 are illustrative, not EEGRAB's books. What is real: WishKey is a shipping EEGRAB product, and the brochure and demo linked above are the company's own public material. The board photograph and layout view are my own working files. I'm glad to walk through the real product and its numbers in a conversation.

---

## 12. Wi-R reference designs — smartglasses and tactical headset

*Ixana · 2024–2026 · Wearable systems*

**Two complete designs an OEM can copy, built to kill the objection that stalls every silicon evaluation: great chip, no path to a product.**
...
**Evidence:** [Reference designs product page](https://www.ixana.ai/products/reference-designs) · [Smartglasses demonstration (video)](https://vimeo.com/1049786530/25db995367) · [Tactical headset demonstration (video)](https://vimeo.com/1146532722/d27318ac13)
...
*Chart: `hbar` · unit % of 27 stalls*

| Item | Value |
| --- | --- |
| Reference designs | 79% — 21 of 27 · value: 79 |
| Expanded documentation | 31% — 8 of 27 · value: 31 |
| More applications hours | 23% — 6 of 27 · value: 23 |

> Options scored against the stalled-evaluation review described in section 02, Dec 2024. Each stall was read for what would actually have unblocked it. Documentation and engineering hours score low for the same reason: most stalls were not caused by missing knowledge but by work the partner did not want to do at all.
...
| Item | Value |
| --- | --- |
| Evaluation started | 27 · value: 27 |
| Link working on our hardware | 24 · value: 24 |
| Own board designed | 11 · value: 11 |
...
- *Shipped:* Smartglasses design — schematic, layout, BOM, firmware; Tactical headset design — schematic, layout, BOM, firmware; Electrode placement guidance for both enclosures; Validated BOM with tested substitutions; Shared firmware tree with per-vertical build flags
- *Deferred:* Multi-node body network design; Published mechanical CAD; Pre-compliance test reports
- *Cut:* Medical patient-monitoring design; Vertical-specific firmware trees; Enclosure tooling and industrial design
...
**Screen — All-day video streaming smartglasses reference design**

![All-day video streaming smartglasses reference design](/static/images/project/wi-r-refdesign-smartglasses.jpg)
...
> Ixana all-day video streaming smartglasses reference design, from Ixana's published product imagery. The design's existence and description are public and a demonstration video is linked above; schematic, layout and BOM are not shown. Happy to walk through the real program in a conversation.

![image](/static/images/project/wi-r-refdesign-tactical.png)

> **** The tactical headset design — headset to body-worn radio over the body rather than the air, which is the property that matters when a radiated link is what locates you. It is the ruggedized end of the bracket described in section 01.
...
| Metric | Value |
| --- | --- |
| Datasheet to working demo on partner hardware | 11 wks → 3 wks |
| Period design-ins citing a reference design in their plan | 6 of 9 |
| Verticals released with schematic, layout and BOM | 2 |
| Design-file packages released to evaluating teams | 58 |
| Evaluations running concurrently | 4 → 12 |
| Applications support hours per evaluation (guardrail) | 9.4 → 9.1 h (per eval) |
...
*Chart: `stackedHBar` · unit weeks*

| Row | Datasheet study | Board design | Board build | Bring-up | Integration | Total |
| --- | --- | --- | --- | --- | --- | --- |
| Before | 2 | 3 | 2 | 3 | 1 | 11 weeks |
| After | 1 | 0 | 0.5 | 0.5 | 1 | 3 weeks |

> Median evaluation cycle before and after, from the stalled-eval review and from twelve evaluations run on the released designs, Jan 2025 – Jan 2026. The phase that vanishes is board design, which is the point: we did not make partners faster at the hard step, we removed it.
...
> **Note.** This is a sample portfolio page about real reference designs. The designs, their published descriptions and the demonstration videos are public and linked above. Program figures — evaluation cycle times, support hours, design-in attribution and file releases — are invented placeholders and should be replaced with real data before this page is used. No schematic, layout, BOM or partner name is shown. I'm glad to walk through the real program and its numbers in a conversation.

---

## 13. Cost-effective smart watch

*EEGRAB · 2023 · Consumer wearable*

**A watch that loses in the shop and wins on the wrist: the colour screen went, and a week of battery came back with it.**
...
*Chart: `hbar` · unit % of first-build bill of materials*

| Item | Value |
| --- | --- |
| Display and driver | 34% — one decision, a third of the cost · value: 34 |
| Processor, radio and passives | 22% — already a single part · value: 22 |
| Battery and charging | 16% — falls out of the display decision · value: 16 |
| Enclosure, strap and glass | 15% — tooled, so effectively fixed · value: 15 |
| Sensors | 13% — the reason anyone buys it · value: 13 |

> Costed from the first Smart Band build at 5,000 units, Q1 2023. The sensors are the cheapest line and the whole point of the product; the display is the most expensive line and the part a buyer forgets about within a fortnight. Every argument on this page follows from that inversion.
...
*Chart: `pairedBars` · unit ₹ per unit at 5,000 units*

| Item | Value |
| --- | --- |
| Display | before: 390 · after: 190 |
| Processor, radio | before: 250 · after: 195 |
| Battery, charging | before: 180 · after: 140 |
| Sensors | before: 150 · after: 145 |
| Enclosure | before: 170 · after: 150 |

> Nine teardowns costed at our own volume, Q2 2023. The strategy is one bar: spend roughly half what the tier spends on the display and match them everywhere else, including on sensors. Undercutting on sensors would have saved ₹5 and removed the reason the watch exists.
...
- *Shipped:* Reflective always-on display; Optical heart-rate sensing; Six-axis motion sensing for steps and sleep; Skin temperature; Phone notifications over Bluetooth; Nine days between charges
- *Deferred:* A white-label firmware variant; Over-the-air firmware update; A second display option in the same footprint
- *Cut:* Colour screen; Blood-oxygen readings; Wi-Fi
...
**Screen — Rendered view of the final smart watch board: a 48-pin processor bottom left, a second sensor package, two crystals, board-edge connectors and a discrete antenna network**

![Rendered view of the final smart watch board: a 48-pin processor bottom left, a second sensor package, two crystals, board-edge connectors and a discrete antenna network](/static/images/project/eegrab-smartwatch-board-3d.png)
...
> My own board view from the project's EasyEDA workspace, rev 1.0, January 2024. Component placement and the parts visible are real; every cost and performance figure on this page is invented.

![image](/static/images/project/eegrab-smartwatch-schematic.png)

> **** The final sheet. Almost everything on it is either the processor or a consequence of not using a radio module: the two crystals, the matching network at the antenna pin, and the regulator. The sensors, display and temperature channel are each a short branch off one bus.
...
| Metric | Value |
| --- | --- |
| Landed bill of materials | ₹820 (at 5,000 units) |
| Retail price band the design targets | ₹2,000–2,500 |
| Battery life between charges | 9 days (on the agreed profile) |
| Warranty return rate (guardrail) | 2.1% (first 12 months) |
| Sensor channels | 3 (heart rate, motion, temperature) |
| Board revisions to production | 4 (three bands plus the final) |
...
*Chart: `trajectory` · x: Landed bill of materials, ₹ per unit at 5,000 units · y: Days between charges*
...
**Capacity forecasts for thirty engineers stopped depending on anyone remembering to file an update.**
...
| Stage | Live, running monthly across three teams |
| Status | Shipped internally |
...
- **Problem.** Engineering capacity was compiled by hand from 58 task lists once a month. Timing three consecutive cycles put the compile at a median of nine hours, each carrying about eleven errors a lead caught by recognising a number that looked wrong — which means the plausible ones went out.
- **What I did.** I defined the reporting rules first and automated second: what counts as committed, how a working day is calculated, how an undated task is handled. Only then did I own delivery of the workflow that applies those rules and writes one report per team.
- **Result.** The monthly compile went from nine hours to twenty minutes of review. Errors fell to two a cycle, all three teams use one definition of committed capacity, and the report requires nothing from any engineer.

### 01 — Why this, and why now

The obvious framing — automate a manual report — had been available for a year and nobody acted, because nine hours a month is annoying rather than urgent. What made it urgent was two teams giving a director conflicting availability figures for the same engineers in the same week. I sized the problem by how often the report was contradicted rather than by hours saved.

**Figure — Over six months of capacity reports: 4 direct contradictions between teams, 11 errors per cycle caught in review, 9 hours per cycle to compile**  
*Chart: `hbar` · unit per cycle unless noted*

| Item | Value |
| --- | --- |
| Errors caught in review, per cycle | 11 errors · value: 11 |
| Hours to compile, per cycle | 9 hours · value: 9 |
| Cross-team contradictions, 6 months | 4 in 6 months · value: 4 |

> Problem sizing, Apr 2025, from three timed compile cycles and a review of six months of circulated reports. The contradictions are the smallest bar and the reason the work was funded — a report that two teams disagree about stops being used for planning.

Automating the existing process would only have made the contradictions arrive faster. The sequencing that mattered was agreeing definitions with all three leads first.

### 02 — The problem as people experienced it

I timed three consecutive monthly compiles end to end, recording every step, correction and judgement call. A time-and-motion study rather than an interview, because the person doing it called it "a couple of days" and could not say where the time went.

| What they did | Where it broke | Evidence |
| --- | --- | --- |
| Exported tasks from 58 lists | Lists were added and renamed without notice | 3 of 3 cycles; 2 lists missed in one |
| Counted days between start and due dates | Calendar days counted weekends as capacity | 3 of 3; systematically overstated availability |
| Guessed at tasks with no dates | No rule existed, so the guess varied by cycle | Median 34 undated tasks per cycle |
| Pasted results into three team tabs | Copy errors were invisible until a lead objected | 11 errors per cycle caught in review |

**Figure — Median minutes per compile step across three timed cycles: exporting and cleaning 214, date arithmetic 168, handling undated tasks 96, assembling tabs 62**  
*Chart: `hbar` · unit minutes*

| Item | Value |
| --- | --- |
| Exporting and cleaning | 214 min · value: 214 |
| Date arithmetic | 168 min · value: 168 |
| Handling undated tasks | 96 min · value: 96 |
| Assembling team tabs | 62 min · value: 62 |

> Time-and-motion study, three monthly cycles, Apr–Jun 2025. Date arithmetic being the second-largest cost is the finding that shaped the product: it is entirely mechanical, it was being done by hand, and it was being done wrong the same way every month.

The reframe: the expensive part was not the report, it was the absence of a rule. Ninety-six minutes a cycle went on undated tasks, a decision made afresh each month by whoever was compiling — which is how two teams held contradictory numbers in good faith.

### 03 — My role and approach

I owned the reporting definitions and delivery of the workflow that enforces them. The definitions were negotiated with three leads before any automation was built, and written into a metrics note the workflow implements literally.

**Key decisions**

- **Working days, not calendar days.** Calendar days had been inflating available capacity by roughly two sevenths. Switching meant every historical figure looked worse, which is the conversation in section 05.
- **A written rule for undated tasks, not better prompting to add dates.** Asking engineers to date every task is a request that decays. Undated tasks are excluded and counted separately, so the report degrades visibly instead of silently.
- **One branch per team, one definition shared.** Each team gets its own tab; none gets its own rules. Separating presentation from definition is what stopped the contradictions.
- **The report must require nothing from engineers.** Every previous attempt had asked developers to update something. Zero engineer input was a hard constraint, which ruled out several better-looking designs.

### 04 — What I cut

**Scope**

- *Shipped:* 58 list ingestion in batches; Working-day capacity calculation; Undated task handling and count; Per-team report tabs; Timezone offset correction on due dates
- *Deferred:* Forward-looking capacity projection; Alerting on overcommitment; Per-project rollup
- *Cut:* Per-person daily granularity; Skill-based allocation matching; Live continuous refresh

Per-person daily granularity was the hardest cut, and is genuinely more useful for planning a week. It failed on data quality: task dates here are accurate to about a week, so a daily view would present noise to three decimal places. We report weekly buckets, with the undated-task count beside every figure as a standing statement of what the number does not know.

### 05 — How I got it agreed

The engineering director pushed back on working days, and his argument was better than it sounded. The switch cut reported available capacity by nearly a third overnight, and he was about to take a resourcing case to the executive team. His position: the new number is differently defined rather than more true, and changing definitions in the same quarter as a headcount request makes the request look manufactured.

He was right about the timing and wrong about the truth, and I only got anywhere by conceding the first half. I proposed reporting both figures for one quarter — calendar days as the headline he had been quoting, working days beside it, the gap stated as a definitional change rather than a discovery. That let the resourcing case proceed on consistent numbers while making the correction visible.

He agreed, and added that after the transition quarter the calendar-day figure would be removed entirely rather than kept as an option. That was sharper than my proposal — I would have left both and let teams choose, which is exactly how the contradictions started.

### 06 — What was built

A scheduled workflow that iterates 58 task lists in batches, maps tasks to thirty engineers across three teams, calculates committed and tentative capacity in working days, handles undated tasks by rule, corrects timezone drift on due dates, and appends a formatted report to each team's tab. It needs no input from any engineer and produces a report a lead reviews rather than assembles.

**Screen — Team capacity tab after a run, recreated with invented allocations — with numbered callout arrows drawn on top**

- **The undated task count sits beside the capacity figure, not in a footnote.** It is the honest error bar on every number in the row, and putting it out of sight would make the report look more certain than the data is.
- **Capacity is bucketed weekly.** Daily columns were requested and refused — task dates in this data are accurate to about a week, and a daily view would invite decisions the data cannot carry.
- **The definition is printed on the sheet.** Two teams once held contradictory figures in good faith. The rule travels with the report so it cannot be separated from the number.
- **Team tabs are separate, the rules are not.** Each lead wanted their own view; giving each their own definition is what caused the original problem.

> Recreated from the internal workbook. Structure and columns are accurate; all names, allocations and figures shown are invented. Happy to walk through the real report in a conversation.

### 07 — Tradeoffs

| Tension | What I chose | What it cost |
| --- | --- | --- |
| Precision vs honesty | Weekly buckets with a visible undated count | Leads planning a specific week still do that part by hand |
| Coverage vs rate limits | Batched iteration across list IDs rather than continuous polling | The report is a monthly snapshot, and a mid-month reorganisation is invisible until the next run |
| Zero engineer input vs data quality | Read whatever the task tool holds, and report what is missing | Roughly 34 tasks a cycle sit outside committed capacity entirely |
| One definition vs team autonomy | Shared rules, separate presentation | One team lost a distinction they valued between committed and reserved time |

### 08 — Impact and outcomes

We agreed before build that this failed if the report still needed a manual edit before a director could read it. The guardrail was engineer input: if the report ever came to depend on developers updating something, it would quietly stop being accurate within two months, which is what happened to both previous attempts.

| Metric | Value |
| --- | --- |
| Monthly compile, now review only | 9h → 20m |
| Reporting errors caught per cycle | 11 → 2 |
| Task lists covered per run | 58 |
| Engineers reported on | 30 (across 3 teams) |
| Definitions of committed capacity in use | 3 → 1 |
| Updates required from engineers (guardrail) | 0 |

**Figure — Minutes to produce each team report before and after automation: RTL 214 to 9, AMS 186 to 7, PS 141 to 6**  
*Chart: `groupedHBar` · unit minutes*
...
> Report production time by team, before from the timed cycles Apr–Jun 2025, after measured over three runs in Oct–Dec 2025. The after figures are machine time; the twenty minutes in the tile above is the lead's review, which did not exist before because there was nothing to review that they had not just built themselves.

> **How we counted.** Committed capacity means working days on tasks carrying a start date, a due date and an assignee, excluding weekends and published holidays. Tasks missing any of the three are excluded and counted separately as undated. That exclusion is deliberately visible — a capacity figure quietly absorbing its own uncertainty is the failure this replaced.

`Technical configuration — n8n scheduled workflow · 58 list IDs iterated in batches · parallel branch per team · working-day calculation excluding weekends and published holidays · timezone offset correction on due dates · append to Excel per team tab`
...
*Ixana · 2026 · Engineering ops*

**One live view of the PS, AMS and RTL delivery pipelines, so a weekly review starts from the same picture instead of three reconstructions of it.**
...
| Item | Value |
| --- | --- |
| Assembling review material | 96 h / mo · value: 96 |
| Chasing delay explanations | 54 h / mo · value: 54 |
| Reconciling bandwidth | 22 h / mo · value: 22 |

> Opportunity sizing, Jan 2026, from two weeks of calendar sampling across 11 leads and architects. Assembly and delay-chasing were the same underlying problem seen twice, which is why one product addressed both and the bandwidth rebuild waited a quarter.
...
| Item | Value |
| --- | --- |
| Reading comment threads | 19 min · value: 19 |
| Editing the task export | 14 min · value: 14 |
| Reconciling bandwidth | 6 min · value: 6 |
| Assembling the summary | 2 min · value: 2 |

> Time-and-motion observation, eight weekly reviews across PS, AMS and RTL, Jan–Feb 2026. Reading comment threads to reconstruct a delay reason was the largest single cost and the one nobody had named — leads described the problem as "exporting", because that is the part that feels like work.
...
- *Shipped:* Three per-team pipeline views; Historical delay analysis; Task drill-down drawer; Velocity leaderboard; Grounded efficiency assistant
- *Deferred:* Cross-team dependency links; Email digest of stalled work; Custom stage definitions in the UI
- *Cut:* Automatic stage inference for RTL; Predicted completion dates; Write-back to the task tool
...
| Metric | Value |
| --- | --- |
| Leads running a weekly review in it | 26 (of 31) |
| Median review preparation time | 41m → 12m |
| Sources opened before a review | 3 → 1 |
| Tasks auto-classified into the right stage | 71% |
| Stages corrected by a lead (guardrail) | 4.2% |
| Delivery pipelines modelled separately | 3 |

**Figure — Median review preparation minutes before and after, by team: PS 44 to 11, AMS 38 to 10, RTL 41 to 16**  
*Chart: `pairedBars` · unit minutes*

| Item | Value |
| --- | --- |
| PS | before: 44 · after: 11 |
...
> **Note.** This is an internal product. The screen described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample. I'm glad to walk through the real system and the underlying numbers in a conversation.

---

## 17. Task change audit trail

*Ixana · 2026 · Audit tooling*

**Turned a raw activity feed into a searchable record of who changed what, so a question that used to take an afternoon takes about four minutes.**
...
*Chart: `hbar` · unit person-hours / quarter*

| Item | Value |
| --- | --- |
| Task change history | 123 h — 41 requests · value: 123 |
| Access review | 18 h — 6 requests · value: 18 |
| Document approval history | 9 h — 4 requests · value: 9 |

> Sizing from a quarter of support records, Apr 2026. Task change history was an order of magnitude more expensive than the alternatives, almost entirely because each individual answer took about three hours rather than because the requests were especially frequent.
...
*Chart: `hbar` · unit of 41 requests*

| Item | Value |
| --- | --- |
| Needed a previous value | 31 / 41 · value: 31 |
| Concerned a due date | 24 / 41 · value: 24 |
| Answered from memory | 17 / 41 · value: 17 |
| Never answered at all | 5 / 41 · value: 5 |

> Support ticket audit, one quarter, Jan–Mar 2026. The first bar decided the architecture: three quarters of requests need the value a field used to hold, which the native feed does not retain — so no amount of better searching would have answered them.
...
- *Shipped:* Raw payload storage; Snapshot diffs on status, assignee, priority, due date and custom fields; Filterable and searchable timeline; Signature verification on ingest; Deduplication and replay
- *Deferred:* Attachment and checklist events; Time tracking changes; Export to CSV for auditors
- *Cut:* Multi-space coverage; Automation and bot edits in the default view; Alerting on specific field changes
...
**Screen — Task timeline with a due-date change expanded, recreated in Figma — with numbered callout arrows drawn on top**
...
> Recreated from the internal interface. Layout and interactions are accurate; all tasks, names, values and dates shown are invented. Happy to walk through the real product in a conversation.
...
| Metric | Value |
| --- | --- |
| Median time to answer a change question | 3h → 4m |
| Change requests reaching a person, per quarter | 41 → 6 |
| Requests going unanswered per quarter | 5 → 0 |
| Duplicate timeline records after dedup (guardrail) | 0 |
| Events that are automation edits, shown as a count | 9.2% |
| Parsing rule changes replayed over stored history | 2 |
...
*Chart: `barsThreshold` · unit minutes*
...
> **Note.** This is internal tooling. The screen described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample. No task, customer or individual's activity is shown. I'm glad to walk through the real system and the underlying numbers in a conversation.

---

## 18. Video library and meeting recordings

*Ixana · 2026 · Meeting intelligence*

**Made every recording searchable by what was said in it, so people arrive at the minute that matters instead of scrubbing an hour.**
...
*Chart: `hbar` · unit % of archive*

| Item | Value |
| --- | --- |
| Transcript search | 100% of 212 · value: 100 |
| Automatic minutes only | 46% — meetings long enough to summarise · value: 46 |
| Manual decision register | 12% — observed fill-in rate · value: 12 |

> Opportunity sizing, Feb 2026, across the 212 recordings captured in January. The decision register scored on the fill-in rate of an existing wiki page used for the same purpose, which is the fairest available estimate and a generous one.
...
| Item | Value |
| --- | --- |
| Recordings captured | 212 · value: 212 |
| Opened again at all | 38 · value: 38 |
| Watched past 2 minutes | 14 · value: 14 |
| Produced written notes | 6 · value: 6 |

> Playback funnel for January 2026, from platform logs. The drop from 212 to 38 is the archive problem stated plainly: capturing meetings was solved, and entering them was not.
...
- *Shipped:* Transcript-linked playback; Hybrid search over titles and transcripts; Meeting question answering; Generated minutes with decisions and actions; Folder browsing across both sources
- *Deferred:* Clip creation and sharing; Speaker-level search filters; Retention policy automation
- *Cut:* Speaker diarization correction UI; Live in-meeting notes; Cross-meeting topic threading
...
A library pulling recordings and stored video into one browsable space, storing transcript text with timestamped cues, and opening each recording in a workspace where the transcript is the primary control. People search across titles and what was said, click any line to jump the video there, ask questions grounded in the full transcript, and generate structured minutes.

**Screen — Player workspace with transcript, question panel and notes tab, recreated in Figma — with numbered callout arrows drawn on top**

- **The transcript sits beside the video at equal weight.** Making it a collapsed panel tested badly — people did not discover that lines were clickable, and without that the product is just a video player with extra text.
- **Generated minutes cite the timestamp of each claim.** In the alpha, nobody circulated a generated minute they could not spot-check. A citation to the moment turned it from a draft into something people sent.
- **Search results show the matching line, not the meeting title.** The unit people are looking for is a sentence. Returning a title makes them start the scrub over again.
- **Excluded meetings show as excluded, not as absent.** Silently hiding a recording makes people think the system lost it and go asking. Naming the exclusion ends the search.

> Recreated from the internal interface. Layout and interactions are accurate; all meeting titles, transcript lines and results shown are invented. Happy to walk through the real product in a conversation.
...
| Item | Value |
| --- | --- |
| Recordings indexed | 690 · value: 690 |
| Opened again | 244 · value: 244 |
...
> **Note.** This is an internal product. The screen described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample. No recording, transcript or attendee name is shown. I'm glad to walk through the real system and the underlying numbers in a conversation.

---

## 19. Calendar sync across two tenants

*Ixana · 2025 · Workplace automation*

**Kept Outlook and Gmail calendars in step for people living in both, without letting a single private event title cross between them.**
...
*Chart: `hbar` · unit visible failures / mo*

| Item | Value |
| --- | --- |
| Calendar clashes | 6 / month, externally visible · value: 6 |
| Late expense approvals | 2 / month · value: 2 |
| Stale distribution lists | 0 — internal only · value: 0 |

> Prioritisation, Mar 2025, from the diary study and three months of helpdesk records. Scored on failures a person outside the company would notice rather than on hours saved — which is why the option affecting the fewest people won the quarter.
...
*Chart: `hbar` · unit incidents, 2 weeks*

| Item | Value |
| --- | --- |
| Manual invite forwards | 54 · value: 54 |
| Hand-made time blocks | 22 · value: 22 |
| Double-bookings | 11 · value: 11 |
| Stale blocks found at audit | 4 · value: 4 |

> Diary study, two weeks, n=6, Mar 2025. The forwarding count is the striking one — people had built a manual sync habit and were running it about nine times a week each, which is the work the service was scoped to take over exactly.
...
- *Shipped:* Outlook to Gmail attendee sync; Invite forwarding for non-organised meetings; Subscribable Outlook feed; Google busy time as opaque Outlook blocks; Dry-run preview and job status endpoints
- *Deferred:* Per-user opt-in portal; Selective sync by calendar category; Conflict notifications
- *Cut:* Two-way body and attendee sync; Automatic acceptance of mirrored invites; Sync of past events
...
**Screen — Dry-run preview output for a scheduled sync, recreated as a console view — with numbered callout arrows drawn on top**
...
> Recreated from the service's own output. Structure and fields are accurate; all event names, addresses and times shown are invented. Happy to walk through the real service in a conversation.
...
| Metric | Value |
| --- | --- |
| Double-bookings per month, pilot group | 6 → 0 |
...
> **Note.** This is an internal service. The output described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample. No calendar content is shown. I'm glad to walk through the real service and the underlying numbers in a conversation.

---

## 20. AI product planning operating system

*Ixana · 2026 · Planning tooling*

**Turns a brief into a reviewed, execution-ready plan in minutes — and refuses to let one model approve its own work.**
...
*Chart: `hbar` · unit of 24 plans*

| Item | Value |
| --- | --- |
| Enforced workflow | 21 / 24 · value: 21 |
| Manual review checklist | 11 / 24 · value: 11 |
| Prompt library and training | 4 / 24 · value: 4 |

> Intervention sizing, Dec 2025, by replaying each approach against 24 previously written plans. The checklist scores 11 rather than 21 not because it is a worse checklist but because it is optional — we applied it retrospectively and were generous about how often a busy person would.
...
| Item | Value |
| --- | --- |
| Asserted unsupplied facts | 19 / 24 · value: 19 |
| Estimates not attached to steps | 17 / 24 · value: 17 |
| Steps with no completion test | 15 / 24 · value: 15 |
| Dependencies implied only | 13 / 24 · value: 13 |

> Structured critique of 24 plans generated and used between Sep and Dec 2025. Every plan carried at least two of these four defects, and the top bar matters most — a plan built on an invented fact fails at execution rather than at review.
...
- *Shipped:* Gated intake with one question at a time; Section selection from the master template; Batched plan drafting; Distinct-model review against a scorecard; Single task with a tested checklist
- *Deferred:* Multi-project portfolio view; Team assignment on generated tasks; Integration with the task tool
- *Cut:* Full backlog generation; Autonomous approval without a human; Estimation from historical velocity
...
**Screen — Review stage showing the scorecard, the reviewer's objections and the diff against the previous draft, recreated in Figma — with numbered callout arrows drawn on top**
...
> Recreated from the internal interface. Layout and interactions are accurate; the brief, plan and checklist shown are invented. Happy to walk through the real product in a conversation.
...
| Metric | Value |
| --- | --- |
| Briefs taken through to an approved plan | 41 |
| Median brief to execution-ready checklist | 4h → 25m |
| Median run to human review | 6m40s |
| Planner–reviewer rounds before approval | 3.2 → 1.4 |
| Plans approved by the human on first read | 68% (of 41) |
| Runs where planner and reviewer shared a model (guardrail) | 0 |
...
> Run times across all 41 completed runs, Mar–Aug 2026, from workflow logs. The ceiling matters more than the median: we agreed a run must reach a human inside ten minutes or it stops being part of a working session, and the three runs beyond it all needed two clarification rounds.
...
`Technical configuration — 5 workflow stages · 30-section master template · review loop capped at 5 rounds · 10-point scorecard · distinct model families enforced in code, stronger for planning and cheaper for review · 0.5-day estimate granularity · 85 tests across 10 suites`
...
## 21. AI Lawyer — patent drafting foundation

*Ixana · 2026 · Legal tooling*

**Built and tested the containment, provenance and cost core, then stopped before the drafting agents because prior-art recall never cleared the bar we set.**
...
| Stage | Prototype — never used on a real disclosure, never seen by a user |
| Status | Prototype |
| Slug | `ai-lawyer-multi-agent-multi-llm-shared-memory-generative-sys` |

> **Confidentiality.** Internal prototype. It never drafted a filing and no attorney ever used it. Figures on this page are invented placeholders; no disclosure, filing or attorney work product is shown.

### Summary

- **Problem.** Turning a disclosure into an attorney-review draft is expensive, and both ways it goes wrong are quiet: the system drafts around prior art it never found, or a trade-secret candidate leaves inside a search query.
- **What I did.** I sequenced the build so the parts expensive to retrofit came first — containment, provenance, cost accounting — and put a measurable recall bar in front of any drafting work. Then I held to it when the measurement came back short.
- **Result.** The foundation works, at 49 passing tests. Prior-art recall reached 61% at rank 20 on a 74-item gold set against a bar of 90%, so no drafting agent was built. It has produced zero drafts and was never put in front of an attorney.

### 01 — Why this, and why now

Two framings were available. The exciting one is a multi-agent drafting system, where the interesting work is the agent lineup. The other is that draft quality is downstream of recall, and everything after retrieval is polish on what retrieval found. I sized these by asking where the attorney hours actually went across five completed filings.

**Figure — Attorney hours across five completed filings: prior-art search and reading 34, claim drafting 18, specification writing 15, figures and formalities 9**  
*Chart: `hbar` · unit hours across 5 filings*

| Item | Value |
| --- | --- |
| Prior-art search and reading | 34 h · value: 34 |
| Claim drafting | 18 h · value: 18 |
| Specification writing | 15 h · value: 15 |
| Figures and formalities | 9 h · value: 9 |

> Effort distribution across five completed filings, Jan 2026, from attorney time records. Search is the largest cost and also the one where a miss is invisible — a draft written around missed art looks exactly like a good draft until an examiner finds it.

I also scoped the pilot to the US filing path: mixing two legal standards in one drafting flow puts a jurisdiction condition in every prompt, and the US path has better public data.

### 02 — The problem as people experienced it

I shadowed two attorneys through five disclosures end to end, and built a recall test: 74 US filings in our own domain where the relevant prior art is already known from the prosecution history, used as a gold set.
...
| Reused nothing between filings | Search work was not retained in any form | 5 of 5 started from an empty page |

The reframe: the hard part was never the agent lineup. It was recall, evaluation discipline and the containment boundary around sensitive disclosures — and only one of those three is interesting to build.

### 03 — My role and approach

I owned scope, build order and the operating rules. The build order is the contribution: things that cannot be retrofitted first, drafting conditional on a measurement rather than a date.

**Key decisions**

- **Containment at intake, and inside every outbound client.** Enforcing it in the outbound path too means a new integration cannot accidentally bypass it. It blocked four calls during testing.
- **Retrieval and evaluation ahead of the drafting agents.** No prompt work recovers art that was never retrieved. Building the gold set first let the project fail cheaply.
- **A recall bar agreed before the measurement existed.** 90% at rank 20, written down in February and measured in June. Setting it afterwards makes it negotiable.
- **Attorney-review drafts, never autonomous filing.** The output is a document an attorney edits and signs, removing a category of risk I had no appetite for.

### 04 — What was built

The foundation layer: cost and usage accounting, caching, configuration, the model client, and universal provenance on every artefact — plus the containment gate at intake and in the outbound clients. Alongside it, the retrieval evaluation harness and the 74-item gold set. The drafting agents, shared memory, review loop and export path are specified and were never started. Nothing here has drafted a patent, and no attorney has used it.

**Screen — Containment gate blocking an outbound query, recreated as a console view — with numbered callout arrows drawn on top**

- **The gate blocks and names what triggered it.** A gate that fails silently teaches people to route around it. Naming the matched term makes a block reviewable rather than mysterious.
- **Provenance is attached at creation, not on export.** Retrofitting provenance onto artefacts that already exist is the one thing here that genuinely cannot be done later.
- **Every call carries its own cost record.** Cost per disclosure decides whether this beats outside counsel, and a monthly invoice cannot answer that.
- **The outbound client enforces the gate independently.** Intake-only enforcement means the next integration someone adds is a hole.

> Recreated from the prototype's own output. Structure is accurate; all terms, queries and identifiers shown are invented. Happy to walk through the real prototype in a conversation.

### 05 — What we learned

We agreed in February that prior-art recall below 90% at rank 20 meant no drafting agent would be built. In June it measured 61%, and we stopped. Containment was the guardrail — a system scoring well on recall while leaking a disclosure would be the worse failure, so blocked outbound calls were counted from week one.

**Figure — Prior-art recall at rank 20 on a 74-item gold set: keyword search 38 percent, dense retrieval 52 percent, hybrid with refinement 61 percent, against a 90 percent bar**  
*Chart: `hbar` · unit % recall at 20, n=74*

| Item | Value |
| --- | --- |
| Hybrid with query refinement | 61% · value: 61 |
| Dense retrieval alone | 52% · value: 52 |
| Keyword search alone | 38% · value: 38 |
| Required bar before drafting | 90% — not reached · value: 90 |

> Retrieval evaluation against a 74-item gold set of US filings with known prior art, Jun 2026. The bar was set in February, before any of these numbers existed. Hybrid retrieval with refinement is a large improvement over keyword search and nowhere near what drafting on top of it would require — which is the whole finding.

| Metric | Value |
| --- | --- |
| Prior-art recall at 20 on a 74-item gold set | 61% (bar was 90%) |
| Tests passing on the provenance and cost core | 49 |
| Outbound calls blocked at the containment gate (guardrail) | 4 |
| Drafts produced; never used on a real disclosure | 0 |

Three things outlast the attempt. The gold set is reusable by anything that later tries this problem. The containment gate is worth having independently and has been proposed for other tools that send text to external services. And several assumptions in the plan were simply wrong, both surfacing during retrieval work rather than far more expensively later.

`Prototype configuration — 7 planned retrieval sources, 3 integrated · 74-item US gold set · containment gate at intake and in outbound clients · prompt cache retention 30 minutes and 24 hours by model · 4 query refinement rounds · 3 critic-loop iterations specified, none built · modelled cost 4–6 dollars per draft cycle`

### 06 — What I'd do differently

I would build the gold set in month one rather than month four. Everything that mattered was decided by a measurement that took three weeks to construct, and I spent the preceding months on foundations that could have run in parallel with it.

I would also have set the bar with the attorney rather than for him. 90% at rank 20 was my number, and when the result came in he pointed out that recall matters very differently in a crowded art area than an empty one — so a single bar across all disclosures was probably the wrong instrument.

> **Note.** This is a prototype that never went to users and never drafted a filing. All figures on this page are invented placeholders for this sample, including the recall measurement and the gold-set size. No disclosure, filing or attorney work product is shown. I'm glad to walk through the real prototype and what stopped it in a conversation.

---

## 22. Reporting and Gantt dashboard

*Ixana · 2026 · PM tooling*

**A read-only timeline and bandwidth view over live task data, with the delay explanation already read out of the comment thread.**
...
- **What I did.** I scoped a read-only analytics layer over the live workspace — a custom timeline engine, bandwidth grids, and delay analysis that synthesises comment threads — and made read-only a permanent constraint rather than a first-version simplification.
- **Result.** 22 of 31 leads and architects use it weekly, hand-built timelines have stopped, and 63% of delay questions are answered without opening the underlying task. Nothing it does has ever written to the workspace.
...
*Chart: `hbar` · unit weeks to reverse*

| Item | Value |
| --- | --- |
| Read-only analytics layer | 1 week — delete it · value: 1 |
| Native workspace automations | 6 weeks — unpick the changes · value: 6 |
| Portfolio management product | 16 weeks plus migration · value: 16 |

> Options sizing, Mar 2026, estimated with the two engineers who would build it. Reversibility was the deciding axis because two previous PM tools at the company had become load-bearing before they were validated, and both were still being maintained years after anyone chose them.

Reversibility is rarely the strongest argument for a product, and it was here because the problem was small and well understood. Hand-building a timeline costs five minutes; nobody would fund a sixteen-week migration to save it, and the honest sizing said so.
...
*Chart: `hbar` · unit of 22 surveyed*

| Item | Value |
| --- | --- |
| Estimated capacity from memory | 18 / 22 · value: 18 |
| Rebuilt a timeline each cycle | 14 / 22 · value: 14 |
| Maintained a personal spreadsheet | 9 / 22 · value: 9 |
| Had given up on timelines | 6 / 22 · value: 6 |

> Survey of 22 leads and architects, Mar 2026, following five shadowed planning sessions. The last row is the finding a usage metric would never have surfaced — six people had quietly stopped trying to plan visually, and would not appear in any measure of demand for a timeline.
...
- *Shipped:* Custom SVG timeline with scale switching; Team bandwidth allocation grid; Hierarchical task tree; Status board; Generated delay explanations
- *Deferred:* Saved view sharing; Scheduled export to a deck; Milestone annotations
- *Cut:* Cross-workspace rollup; Any write-back to the workspace; Predicted completion dates

Cross-workspace rollup was the hardest cut — three directors asked for it directly. It failed on rate limits and on meaning: several workspaces pushed our API consumption past what the endpoint tolerated at the cache lifetimes we needed, and they use incompatible status vocabularies, so a rolled-up number would average things that are not the same. A saved multi-list view covers most of the real question.
...
**Screen — Timeline view with the bandwidth grid beneath, recreated in Figma — with numbered callout arrows drawn on top**
...
- **The bandwidth grid shows unallocated time as empty, not as available.** An engineer with no assigned tasks is usually mis-recorded rather than idle, and colouring that as capacity would drive real staffing decisions off a data gap.

> Recreated from the internal interface. Layout and interactions are accurate; all tasks, names and dates shown are invented. Happy to walk through the real product in a conversation.
...
`Technical configuration — custom SVG timeline renderer · server-side route handlers holding all credentials · 5-minute cache on team task queries · 30-minute cache on generated delay analyses · gpt-4o-mini for comment-thread synthesis`

### 09 — What I'd do differently

I designed for leads and architects arrived through a different door. Delay analysis was scoped as a supporting feature for the timeline; for architects it is the product — they open it directly, ignore the Gantt, and have been asking for depth in the one place I resourced least. Segmenting the 22 survey responses by role would have caught this; I read them in aggregate.

I would also revisit the thirty-minute cache on delay analysis. It was set to control generation cost when I had no usage data, and the effect is that two people looking at the same slipped task ten minutes apart can see different explanations. That small inconsistency has cost more credibility in one meeting than the caching has saved all year.

> **Note.** This is an internal product. The screen described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample. I'm glad to walk through the real product and the underlying numbers in a conversation.

---

## 23. Patent program operations

*Ixana · 2024–2026 · Patent operations*

**Fifty-plus filings across six product lines, owned end to end — and disclosure-to-filing cut from fourteen weeks to six on no extra inventor time.**

| Field | Detail |
| --- | --- |
| Role | Product manager — patent programme owner and Wi-R product line PM |
| Team | Founder/CTO on strategy, outside counsel on execution, 1 engineer |
...
*Chart: `hbar` · unit k / yr*

| Item | Value |
| --- | --- |
| Push docketing to counsel | $90k / yr · value: 90 |
| Hire a paralegal | $75k / yr · value: 75 |
...
| Column | BAN YR23 | BAN YR31 | NFE XA-NFE2001 | NFE XA-NFE3001 | Reference designs | Dev kits |
| --- | --- | --- | --- | --- | --- | --- |
| H1 '24 | 5 | 0 | 2 | 0 | 0 | 1 |
| H2 '24 | 3 | 4 | 2 | 0 | 0 | 1 |
| H1 '25 | 1 | 4 | 3 | 2 | 1 | 1 |
...
**From the quarterly coverage review — one page, per product line**

*Every line gets one of four calls, agreed with the founder/CTO in the same hour*
...
> One page from the quarterly review. The per-line detail and every matter reference have been removed.

### 04 — What I cut

**Scope**

- *Shipped:* Mail-triggered extraction into matter and category; One internal matter identity across three firms; Lifecycle view over six stages, plus an explicit unclassified stage; Internal readiness dates, each carrying its provenance; Invoice lines matched against the quoted schedule; Weekly reconciliation against counsel’s docket
- *Deferred:* Inventor-facing disclosure portal; Family-level cost roll-up; Category coverage measured against the roadmap
- *Cut:* Machine-drafted claim language; Automated freedom-to-operate scoring; Any statutory date computed by us
...
**From the programme note — what we will not automate, v1.1**

*Three categories stay with a person, permanently, and not as a first-version simplification*
...
> One page from the programme note. The examples naming live matters have been removed.
...
A mail-triggered spine and four surfaces over it. Documents from any of the three firms are extracted, matched to one matter identity, given a stage and a category, and written into one record — four views of it, not four tools.

**Screen — Patent portfolio spend and milestone timeline, one lane per matter across 2024 to 2026**
...
> The real interface, re-rendered on an invented dataset — same code, same layout, same stage model, with matters, firms, application numbers and amounts that belong to no real filing.
...
> Recreations of the four remaining surfaces, built from the real layouts and states and filled with the same invented dataset as the screen above.
...
`System configuration — mail-triggered extraction into 6 lifecycle stages and 5 technology categories, plus an explicit unclassified stage · one internal matter identity mapped across 3 outside firms · invoice lines matched individually against the quoted schedule · deadline colouring at 60 days, 6 months and 1 year · no statutory date computed anywhere in the system`
...
| Metric | Value |
| --- | --- |
| Median disclosure to filing | 14w → 6w |
| Active matters with no owned next action | 19 → 2 (of 54) |
| Inventor minutes per disclosure (guardrail) | 95m → 40m |
| Named inventors and reviewers active in a quarter | 26 of 31 |
| Dates disagreeing with counsel’s docket | 0 |
| Places opened to answer what is owed | 6 → 1 |
...
I built the mechanism before I wrote down the strategy. For a year the filing decisions lived in my head and in a conversation with the founder, while what got documented was the plumbing beneath them. How a tapeout maps to a filing decision is still the part I cannot hand over.

I would also have measured the tail earlier. Section 08 says we fixed the first thirty days and left everything past sixty where it was — and that tail is inventor availability in a tapeout crunch.

> **Note.** Sample page — internal legal operations. Every screen here is real software showing invented data: the timeline in section 06 is the actual product re-rendered on a synthetic dataset, the four surfaces beside it are recreations built from the real layouts. No raw capture was published, cropped or traced, because every one of them carried real matter titles, application numbers, firm names or fee amounts. All figures on this page are invented placeholders apart from the public documents linked above, which are live and assignee-verified. No unpublished subject matter, claim, inventor, attorney, firm, matter number, statutory date or real fee appears anywhere. I’m glad to walk through the real programme and the underlying numbers in a conversation.

---

## 24. Patent dashboard sync

*Ixana · 2025 · Portfolio ops*

**Stopped the portfolio dashboard double-counting continuation rows, and made the combined view rebuild itself from its three sources instead of being maintained by hand.**

| Field | Detail |
| --- | --- |
| Role | Product manager, delivery owner |
| Team | 1 engineer, with the patent paralegal as domain owner |
| Timeline | Jun – Nov 2025 |
| Stage | Live, running against the live workbooks |
| Status | Shipped internally |
| Slug | `patent-tracker-generative-ai-engine-for-data-extraction` |

> **Confidentiality.** Internal tooling over a live patent portfolio. Counts, timings and figures on this page are invented placeholders; no filing, title, inventor or application number is shown.

### Summary

- **Problem.** Three workbooks fed a summary built on live formulas that counted rows rather than patents, so every continuation inflated the total. A row-by-row audit found 41 double-counted rows against 248, and the master had also drifted from its sources by up to three days after manual edits.
- **What I did.** I made the master a derived artefact rather than a maintained one, owning the counting rules, the refresh behaviour, and the boundary the service must never cross: it never writes to the source data anyone actually works in.
- **Result.** Double-counted rows went to zero, the master realigns within a minute of a source change instead of drifting for days, the monthly reconciliation stopped, and no source sheet has been touched.

### 01 — Why this, and why now

Three ways to fix a portfolio view nobody trusted: migrate into a patent management system, rebuild the master by hand each month, or leave the workbooks where people work and derive the combined view from them. I sized these on the cost of being wrong rather than effort — the audience was the board and outside counsel, and an inflated filing count gets repeated in a slide deck for a year.

**Figure — Weeks to a trustworthy portfolio view: derive from existing workbooks 3, hand-rebuild the master monthly 1 but recurring, migrate to a patent management system 22**  
*Chart: `hbar` · unit weeks*

| Item | Value |
| --- | --- |
| Derive from existing workbooks | 3 weeks, then automatic · value: 3 |
| Hand-rebuild monthly | 1 week per month, forever · value: 1 |
| Migrate to a PM system | 22 weeks plus licensing · value: 22 |

> Options sizing, May 2025. The migration was the correct long-term answer and lost on sequencing — it needs a settled definition of what counts as one patent, which is precisely what the audit in section 02 showed we did not have.

The recurring option is the interesting one to reject: a week a month of a paralegal's time is affordable and fails anyway, re-deriving the same wrong counts from the same ambiguous rows.

### 02 — The problem as people experienced it

Rather than interview anyone, I reconciled the data: all 248 rows across three source workbooks, compared line by line against the master and the underlying filings, every disagreement coded by cause. Interviews would have surfaced frustration; only the audit could show what was wrong.

| Disagreement found | Why it happened | Rows affected |
| --- | --- | --- |
| One patent counted more than once | Continuations were separate rows and formulas counted rows | 41 of 248 |
| Status disagreed between master and source | Someone edited the master directly after the last rebuild | 17 of 248 |
| Filing missing from the master entirely | Added to a source workbook after the last rebuild | 9 of 248 |
| Deadline shown as passed when it was not | Date column formatted as text in one workbook | 6 of 248 |

**Figure — Row-by-row reconciliation of 248 rows: 41 double-counted, 17 status conflicts, 9 missing, 6 date errors, 175 correct**  
*Chart: `hbar` · unit of 248 rows*

| Item | Value |
| --- | --- |
| Correct in both | 175 · value: 175 |
| Double-counted | 41 · value: 41 |
| Status conflict | 17 · value: 17 |
| Missing from master | 9 · value: 9 |
| Date parsed wrongly | 6 · value: 6 |

> Reconciliation audit, May 2025, all 248 rows across three source workbooks against the master. About three rows in ten disagreed with something, and the largest cause was definitional rather than clerical — which is why a more careful rebuild would not have helped.

The reframe: the master was not out of date, it was answering a different question. The formulas reported rows; everyone reading believed they were reading patents. Fixing the sync without the counting rule would have produced a dashboard that was wrong faster.

### 03 — My role and approach

I owned the counting rules, the refresh behaviour and the service's boundary. The engineering was modest; the product work was deciding what one patent means and getting that agreed in writing before any code ran.

**Key decisions**

- **The master is derived, never authored.** The source workbooks stay authoritative because that is where people work. A manual edit to the master is not preserved — a deliberate loss.
- **Count patents by group and last-row status, not by row.** Continuations and re-filings share a family and appear as separate rows. Grouping them and taking the latest status is what the paralegal had done mentally for years, written down.
- **Two-stage change detection.** An eTag check first, a content hash second. Workbooks get touched constantly without their contents changing, and refreshing on every touch means near-continuous rewriting of files people have open.
- **Write through the workbook API, not by replacing files.** These workbooks carry formatting and layout the team relies on. Rewriting the file would have been simpler and destroyed the thing that makes them usable.

### 04 — What I cut

**Scope**

- *Shipped:* Deduplicated counting rules; In-place dashboard recomputation; Master rebuild from all three sources; Change detection with verification retries; Health, status and dry-run endpoints
- *Deferred:* Alerting on approaching deadlines; Historical snapshots of the portfolio; Inventor-level reporting
- *Cut:* Write-back to source workbooks; In-app editing of any filing; Automatic reconciliation of conflicting statuses

Writing corrections back to the source workbooks was the hardest cut, and the one with the most obvious value — the audit had just found 32 rows with real errors. A tool that silently corrects a legal record is a tool nobody can testify about. A discrepancy report the paralegal applies by hand costs twenty minutes a month and keeps every change attributable to a person.

### 05 — How I got it agreed

The patent paralegal did not want the master derived, and her objection was not sentimental. She used it as a working surface — annotating rows during counsel calls, flagging things to chase — all of which the next sync would overwrite. She pointed out, correctly, that I was taking away her working tool to fix a reporting problem she had not created.

I was arguing about correctness and she was describing a workflow, so I asked to watch a counsel call. What she wrote during it was almost entirely commentary — chase this, counsel disagrees, waiting on the inventor — and almost none was data the sources held. That let me split the sheet rather than the argument: derived columns rebuild every cycle, and a notes column is read and written back untouched.

She agreed on that basis, with one condition I had not thought of. If a rebuild would drop a row carrying a note, the sync stops and reports — a note attached to a filing that vanished is exactly the case where something has gone wrong upstream. It has triggered twice, and both times something had.

### 06 — What was built

A service that watches three source workbooks, recomputes each dashboard in place under the deduplicated counting rules, and rebuilds the master's combined sheet with a source column. It detects change cheaply, verifies its writes, preserves the notes column, and exposes health, status, dry-run and refresh endpoints.

**Screen — Master workbook dashboard after a rebuild, recreated with invented filings — with numbered callout arrows drawn on top**

- **Every count states the rule beneath it.** The dashboard had been wrong for a year without anyone noticing, because a number with no definition attached cannot be checked by the person reading it.
- **The notes column is visibly outside the derived block.** The paralegal has to be able to see, at a glance, which part of this sheet her work survives in.
- **Last sync time sits at the top, not in a footer.** The failure mode this replaced was silent staleness, so the freshness of the view is the first thing on it.
- **Top-five lists rather than full tables.** Reviewers act on the next few deadlines, not on the portfolio. Showing everything meant nobody read any of it.

> Recreated from the internal workbook. Layout and structure are accurate; all filings, dates and statuses shown are invented. Happy to walk through the real dashboard in a conversation.

### 07 — Tradeoffs

| Tension | What I chose | What it cost |
| --- | --- | --- |
| Correctness vs attributability | Report discrepancies, never correct the source | Known errors sit uncorrected until a person applies them, sometimes for weeks |
| Freshness vs churn on open files | eTag then content hash, poll at a minute | A change made and saved slowly can take two cycles to register |
| Formatting fidelity vs implementation simplicity | Workbook API writes rather than file replacement | Considerably more code, and per-cell write limits shape how the rebuild is batched |
| Automation vs a human checkpoint | Sync halts if a rebuild would drop an annotated row | Two full stops requiring manual investigation, both of which were justified |

### 08 — Impact and outcomes

Before build we agreed the service failed if the master ever disagreed with its sources for more than one working day. The guardrail was source integrity: any modification to a source Patents sheet would have meant switching the service off, because the design rests on those files belonging to the people who maintain them.

| Metric | Value |
| --- | --- |
| Double-counted rows in the portfolio total | 41 → 0 |
| Worst-case staleness of the master view | 3 days → 60s |
| Source sheets modified by the service (guardrail) | 0 |
| Monthly reconciliation effort | ~2h → 20m |
| Writes verified correct on the first attempt | 97% |
| Source workbooks combined into one view | 3 |

**Figure — Reported versus actual patent counts per source workbook before and after the counting rules: 96 to 79, 84 to 71, 68 to 57**  
*Chart: `dumbbell` · unit patents*

| Item | Value |
| --- | --- |
| Workbook A | from: 96 · to: 79 |
...
`Technical configuration — Graph workbook API for in-place writes · eTag then SHA-256 content hash change detection · 60-second default poll · 3 verification retry rounds after each write · top-5 notice and deadline lists per dashboard`

### 09 — What I'd do differently

I fixed the counting before agreeing who owned the number. When the corrected total went out, the first three conversations were about which figure had been in last quarter's board pack. That was predictable and I had not prepared for it — a one-page note circulated a week earlier would have turned an awkward discovery into an unremarkable correction.

I would also have polled less often. Sixty seconds felt responsive and nothing here moves at that speed; a patent status changes a few times a month. A five-minute cycle would have been indistinguishable to users and would have removed most of the autosave write collisions the verification retries exist to absorb.

> **Note.** This is internal tooling over a live patent portfolio. The dashboard described in section 06 is a recreation with invented content, and all counts and figures on this page are invented placeholders for this sample. No filing, title, inventor or application number is shown. I'm glad to walk through the real system and the underlying numbers in a conversation.

---

## 25. Document change intelligence

*Ixana · 2026 · Documentation ops*

**A daily sync that versions and diffs every workspace document, so the ones that changed overnight are visible without anyone being asked.**
...
*Chart: `hbar` · unit % reachable*

| Item | Value |
| --- | --- |
| Change tracking | 100% — no prerequisite · value: 100 |
| Scheduled review | 38% — needs a known owner · value: 38 |
| Ownership drive | 21% — matched register entries · value: 21 |

> Sizing, Jan 2026, from the register reconciliation described below. The two people-led interventions could each only reach the documents already correctly registered, which is the smaller part of the estate — so the observability work had to come first regardless of which remedy we eventually chose.
...
*Chart: `hbar` · unit documents*

| Item | Value |
| --- | --- |
| Matched to a register row | 248 · value: 248 |
| Present but untracked | 53 · value: 53 |
...
- *Shipped:* Daily scheduled sync; Immutable versions on real content change; Line and page level diffs; Change feed and sync run history; Register metadata enrichment where present
- *Deferred:* Notifications to document owners; Approval workflow on changes; Full-text search across versions
- *Cut:* Rich-text semantic diff; Real-time change capture; Automatic pruning of untracked documents
...
**Screen — Document detail with version timeline and diff, recreated in Figma — with numbered callout arrows drawn on top**

- **The change summary sits above the diff, not inside it.** This is what replaced the semantic diff. Most readers need to know whether a change matters; only some need to see it line by line.
- **Registered and unregistered counts are shown separately.** The condition from section 05 — the tool tracks more than the register lists, and must never be mistaken for the canonical inventory.
- **The run history shows checked and changed, not just success.** A sync that checks nothing and reports success looks identical to a healthy one, which is exactly the failure we had for three days.
- **Versions carry no edit button anywhere.** An immutable record with an affordance for changing it is not an immutable record, however well the permissions are configured.

> Recreated from the internal interface. Layout and interactions are accurate; all document titles, content and authors shown are invented. Happy to walk through the real product in a conversation.
...
| Metric | Value |
| --- | --- |
| Documents checked each night | 301 (from 248) |
| Documents changed on the confirmed run | 34 |
| Documents pruned since the policy change (guardrail) | 0 |
| Nightly syncs completing | 98.6% (target 95%) |
| Worst-case age of the newest version | 1 day |
| Documents tracked nowhere | 53 → 0 |
...
> Tracked estate against nightly change volume, Jul–Aug 2026, from sync run records. The step in week five is the tracking policy change bringing in workspace-only documents; the change spike alongside it is those documents being versioned for the first time, not a burst of editing.
...
> **Note.** This is internal tooling. The screen described in section 06 is a recreation with invented content, and all figures on this page are invented placeholders for this sample. No document title, content or author is shown. I'm glad to walk through the real system and the underlying numbers in a conversation.

---

## 26. Condenser microphone

*EEGRAB · 2024 · Audio hardware*

**Two microphones off the same line now measure within 0.4 dB of each other, in a tier where the capsule supplier's own window is fifteen times wider.**
...
*Chart: `hbar` · unit dB of self-noise improvement*

| Item | Value |
| --- | --- |
| Passive step-up before any active part | 4.8 dB — the lever I took · value: 4.8 |
| A quieter capsule grade | 3.1 dB — real, but unpredictable lot to lot · value: 3.1 |
| A lower-noise output stage | 0.9 dB — after the gain, it barely matters · value: 0.9 |

> Modelled from the capsule measurements in section 02, Q1 2024. The output stage scores badly for a reason worth stating plainly: by the time the signal reaches it the transformer has already made it large, so the noise it adds is swamped. Almost all of the available improvement is in the first centimetre of the signal path.
...
*Chart: `dotplot` · unit mV/Pa at 1 kHz*

| Item | Value |
| --- | --- |
| Lot A, first quarter | value: 17 · n: 20 |
| Lot B, second quarter | value: 21.5 · n: 20 |
| Lot C, third quarter | value: 25 · n: 20 |

- Threshold: value 20, label supplier nominal, 20 mV/Pa

> Sixty capsules across three delivered lots, Q1 2024. Within a lot the spread was wide but stable; the finding that mattered is between lots, because it kills the obvious answer. Sorting capsules into grades works beautifully until the next delivery arrives centred somewhere else, and then every grade you defined is wrong.
...
- *Shipped:* Fixed cardioid large-diaphragm capsule; Transformer-coupled passive front end; Per-unit sensitivity trim set at test; 48 V phantom power over XLR; Measured sensitivity and self-noise printed on the box
- *Deferred:* A brighter second capsule variant; An OEM module of the front end alone; A USB output version
- *Cut:* Matched stereo pairs; Switchable polar patterns; A switchable pad and high-pass filter
...
**Screen — EasyEDA schematic titled Condenser Microphone — Passive Calibration, showing the input coupling network, a 1:5 step-up transformer, a parallel RC across the primary, and a trim into the output**

![EasyEDA schematic titled Condenser Microphone — Passive Calibration, showing the input coupling network, a 1:5 step-up transformer, a parallel RC across the primary, and a trim into the output](/static/images/project/eegrab-condenser-mic-front-end-schematic.png)
...
> My own schematic from the project's EasyEDA workspace, rev 1.0, February 2024, with the simulation instruments still placed. The circuit and its component values are real. The capsule specification and every performance figure on this page are invented.
...
| Metric | Value |
| --- | --- |
| Sensitivity consistency of shipped microphones | ±0.4 dB (unit to unit) |
| Self-noise, A-weighted (guardrail) | 17 dBA (worst unit, published) |
| Sensitivity at 1 kHz | 20 mV/Pa (−34 dBV/Pa) |
| Maximum sound pressure level | 134 dB (at 0.5% THD) |
| Capsules accepted from a delivered lot | 74% (under the half-trim rule) |
| Frequency response on axis | 30 Hz – 18 kHz (±3 dB) |
...
*Chart: `strips` · unit dB from nominal*
...
| Shipped microphones after trim | 240 measured at final test · -0.38 · -0.34 · -0.31 · -0.29 · -0.26 · -0.24 · -0.21 · -0.19 · -0.16 · -0.14 · -0.11 · -0.09 · -0.06 · -0.04 · -0.01 · 0.02 · 0.04 · 0.07 · 0.09 · 0.12 · 0.14 · 0.17 · 0.19 · 0.22 · 0.24 · 0.27 · 0.29 · 0.32 · 0.35 · 0.38 · -0.36 · -0.27 · -0.18 · -0.08 · 0.01 · 0.11 · 0.21 · 0.31 · -0.22 · 0.16 · own: true |

> Sixty capsules measured on delivery against 240 microphones at final test, to Q4 2024. The top row is what the supplier considers one part number. The bottom row is the same parts after a trim set against a reference — and the shipped population is narrower than the acceptance band, which is the only reason we can print a consistency figure rather than a typical one.
...
*Chart: `hbar` · unit % of open cases*

| Item | Value |
| --- | --- |
| Bench fault reproduction | 71% — no rig time needed · value: 71 |
| Better field data capture | 34% — helps the next failure, not this one · value: 34 |
| Faster teardown throughput | 12% — the queue was never the constraint · value: 12 |

> Options scored against the returned-tool audit in section 02, Nov 2022. Teardown throughput scores lowest because the labs were not backed up — analysts were idle, waiting on a rig they did not control. Better capture is the right long-term answer and does nothing for a tool already on the bench.
...
| Item | Value |
| --- | --- |
| Failure records reviewed | 84 · value: 84 |
| Not reproducible off-rig | 61 · value: 61 |
| Hypothesis needed field time | 37 · value: 37 |
| Closed unconfirmed | 29 · value: 29 |

> Returned-tool failure records, Jan 2021 – Oct 2022, coded by reproducibility rather than by outcome. The last bar is the finding that funded the work: roughly a third of cases were closed with a fix nobody had watched work, which is not failure analysis, it is an educated guess with paperwork.
...
- *Shipped:* Open-loop playback of catalogued fault signatures; Current, voltage, resistance and frequency channel emulation; Tool-bus interface for sensor traffic; Reference-instrument verification on every channel; Bench parts list and setup procedure
- *Deferred:* Automated regression suites per tool family; Thermal-chamber co-ordination; Fault-signature capture straight from field logs
- *Cut:* Closed-loop tool emulation; Gyroscope dynamic-spin emulation; Multi-fault interaction playback
...
**Screen — Sensor signal generator bench: laptop running the channel front panel, a second screen showing the channel table, a DAQ module, four Fluke meters reading four live channels, a patch panel and boards under test**

![Sensor signal generator bench: laptop running the channel front panel, a second screen showing the channel table, a DAQ module, four Fluke meters reading four live channels, a patch panel and boards under test](/static/images/project/slb-sensor-pack-verification-bench.jpg)
...
> My own photograph of the bench in an SLB failure-analysis lab — a shared high-voltage and current station, hence the signage. Instruments shown are commercial products and the panels shown are channel-emulation VIs. No tool identity, fault-library content or customer data is visible. Happy to walk through the real bench in a conversation.

![image](/static/images/project/slb-sensor-pack-can-interface.jpg)

> **** The tool-bus side — a CAN HS/FD interface carrying sensor traffic to the tool electronics under test, alongside the analogue channels. Sensor faults arrive on a downhole tool through both paths, so a bench that only drove analogue signals would miss the bus-level fault modes entirely.

![image](/static/images/project/slb-sensor-pack-bench.jpg)

> **** One channel, closer in: an accelerometer emulation VI on the left and a handheld meter reading the current it is putting out on the right. Most downhole sensors report as a current rather than a voltage, so the generator sinks and sources current directly instead of driving a voltage into an assumed load.
...
| Metric | Value |
| --- | --- |
| Field fault signatures reproduced on the bench | 98.2% (55 of 56) |
| SLB failure-analysis labs running the bench | 40+ |
| Time to reproduce a reported field fault | weeks → under a day |
| Fault modes in the signature library | 56 |
| Sensor channel families emulated | 5 |
| Agreement with calibrated reference (guardrail) | ±0.4% (of reading) |
...
> The catalogued fault library at handover, Aug 2023, one cell per fault mode. Drawn as units rather than a percentage because the remainder is a specific thing, not a rounding error: the outstanding mode is an intermittent thermal-cycling fault that only appears while the temperature is moving, which open-loop playback cannot hold.
...
*Chart: `hbar` · unit % of a loiter before being noticed*

| Item | Value |
| --- | --- |
| Flapping wing, bird silhouette | 71% — the bet this project exists to test · value: 71 |
| Fixed-wing micro air vehicle | 38% — quiet, but nothing loiters like that · value: 38 |
| Small quadcopter | 24% — heard before it is seen · value: 24 |

> Scored against the near-ground surveillance tasks the club's own brief listed, Q3 2021. The quadcopter bar is the club's starting observation rather than ours: their brief already said swarm drones are identifiable and can be eliminated at first sight, which is what pointed at a bird in the first place.
...
- Points (% of observers saying "a bird"): 20 m 31, 40 m 68, 60 m 84, 80 m 89
...
**Screen — Concept render of the ornithopter: segmented flapping wings on spars, a fuselage carrying electronics and a nose camera, and a swept tail**

![Concept render of the ornithopter: segmented flapping wings on spars, a fuselage carrying electronics and a nose camera, and a swept tail](/static/images/project/Image__20_.jpg)
...
> The whole campaign, Q1–Q2 2022. The order is the finding: nothing improved until a weight moved, and the change that produced three clean flights was not a change to the mechanism anyone had been working on. Flight seven still broke a spar, so the fix was real but partial.

| Metric | Value |
| --- | --- |
| Longest controlled flight | 41 s (best circuit, camera aboard) |
| Flights that finished as intended | 9 → 3 (attempted → completed) |
| Payload margin with the camera | +6 g (over airframe and battery) |
| Bird-mistake rate (guardrail) | 68% (observers at 40 m) |
...
*Chart: `hbar` · unit % of lifetime carbon addressable*

| Item | Value |
| --- | --- |
| Where the electricity comes from | 62% — and entirely outside the vehicle · value: 62 |
...
*Chart: `pairedBars` · unit t CO₂e over 200,000 km*

| Item | Value |
| --- | --- |
| Coal-heavy, 820 g/kWh | before: 42 · after: 36 |
| Indian mix 2020, 700 | before: 42 · after: 32 |
| Low-carbon, 120 g/kWh | before: 42 · after: 14 |

> Nine scenarios reduced to the three that move the answer, Q3 2020. The petrol bar barely changes and ours moves by a factor of two and a half — the same vehicle is either a modest improvement or a transformative one depending on a decision made at a power station. None of the bars goes below zero.
...
**Screen — The team's system diagram of the wind-power charging and air-purification path: air entering the radiator, a cylindrical turbine, wind controller, filter stack, drive system and energy storage**

![The team's system diagram of the wind-power charging and air-purification path: air entering the radiator, a cylindrical turbine, wind controller, filter stack, drive system and energy storage](/static/images/project/ricky-kids-carbon-positive-ev-turbine-purifier.jpg)
...
*Chart: `waterfall` · unit t CO₂e*

| Item | Value |
| --- | --- |
| Petrol equivalent, 200,000 km | 42 t · value: 42 · kind: total |
| Fuel and tailpipe, removed | −36 · value: -36 · kind: subtract |
| Grid electricity over life | +21 · value: 21 · kind: add |
| Extra embodied carbon | +5 · value: 5 · kind: add |
| Rooftop solar over life | −2 · value: -2 · kind: subtract |
| Onboard turbine, net of drag | +1 · value: 1 · kind: add |
| Air-purification load | +1 · value: 1 · kind: add |
| The concept, modelled | 32 t · value: 32 · kind: total |

> At the 2020 Indian grid intensity, Q4 2020. Two of the three features the concept was named for are red bars — the turbine and the purifier both cost carbon rather than removing it. The floor of this chart is zero, and carbon positive would need the final bar to be below it.

| Metric | Value |
| --- | --- |
| Net lifecycle carbon (guardrail) | +32 t CO₂e (emitted over 200,000 km) |
| Best claim the model supports | 24% (below a petrol equivalent) |
| Net contribution of the onboard turbine | −3% (range, after added drag) |
| Scenarios modelled | 9 (3 grids × 3 lifetimes) |
...
*Chart: `hbar` · unit % of the antenna pattern reachable*

| Item | Value |
| --- | --- |
| UAV carrying a metal sphere | 84% — flies to the pattern instead of waiting for it · value: 84 |
| Tethered balloon | 22% — altitude yes, azimuth no · value: 22 |
| Fixed tower or pedestal | 4% — really one point, built once · value: 4 |

> Scored against the elevation and azimuth range each option can place a target in without moving the radar, Q1 2022. The pedestal figure is generous: a fixed reference is not four percent of a pattern, it is a single point in it, expressed as coverage so the three sit on one scale.
...
*Chart: `dumbbell` · unit dB*

| Item | Value |
| --- | --- |
| S-band, sphere and external GNSS | from: 1.8 · to: 1.5 |
| Polarimetric X-band characterisation | from: 1.4 · to: 1.1 |
| UAV against a pedestal reference | from: 1.1 · to: 0.9 |
| Altitude-limited trial | from: 2.2 · to: 1.9 |

> Four published experiments, decomposed Q1 2022. The left dot is what each paper reported; the right dot is what we could attribute to knowing where the sphere was. The gap between them is everything else in the radar — and in all four it is the smaller half of the problem.
...
**Screen — ricky-kids-uav-radar-geometry.png — radar on its tower, the UAV flying a zigzag through the beam at standoff, the sphere and its GNSS box slung below the airframe, and the elevation and azimuth angles derived from the two position fixes**
...
*Chart: `tornado` · unit dB*

| Item | Value |
| --- | --- |
| Sphere position — altitude | 1.33 dB swing · low: -0.62 · high: 0.71 |
| Sphere position — horizontal | 0.45 dB · low: -0.21 · high: 0.24 |
| Sphere radar cross section | 0.30 dB · low: -0.14 · high: 0.16 |
| Scattering off the airframe | 0.24 dB · low: -0.11 · high: 0.13 |
| Receiver linearity | 0.11 dB · low: -0.05 · high: 0.06 |

- Baseline: nominal calibration

> Each term moved across the range the four experiments support, everything else held at nominal, Q2 2022. Altitude alone swings wider than the other four combined. The published advice to prioritise vertical accuracy over horizontal turns out to be derivable rather than a matter of taste, which is the only part of this analysis that felt like a result.

| Metric | Value |
| --- | --- |
| Error swing traced to sphere positioning | 1.4 dB (of a 1.5 dB budget) |
| Positioning accuracy the method demands (guardrail) | ±0.35 m (altitude, 1σ) |
| Error budgets decomposed | 4 (published experiments) |
| Angular coverage one flight pattern reaches | ±12° (elevation, at 350 m standoff) |
...
*Chart: `hbar` · unit % of observed entries*

| Item | Value |
| --- | --- |
| Taking a routine observation | 58% — reading numbers off a patient · value: 58 |
| Medication and treatment | 27% — care that has to happen in the room · value: 27 |
| Patient request or comfort | 15% — and the part nobody wants to reduce · value: 15 |

> Entries logged during observation rounds across three wards, Q3 2021. The middle and bottom bars are not targets: nobody was trying to reduce the number of times a nurse goes to a patient who asked for one. Only the top bar is a measurement problem, which is what made it worth attempting.
...
*Chart: `stackedHBar` · unit minutes per entry*

| Row | Gowning up | In the room | Doffing and disposal | Total |
| --- | --- | --- | --- | --- |
| Routine observation | 3.5 | 1.2 | 4.8 | 9.5 min |
| Medication round | 3.5 | 4.1 | 4.8 | 12.4 min |
| Patient request | 3.5 | 2.6 | 4.8 | 10.9 min |

> Timed across three wards, Q3 2021. The fixed 8.3 minutes either side is the same whatever happens in between, so for an observation the useful minute is roughly one in eight. That ratio, not any clinical argument, is the whole case for measuring from across the room.
...
**Screen — A commercial multi-parameter patient monitor on a rolling stand, showing heart rate, blood pressure, oxygen saturation, respiration and temperature, with electrode leads, a finger probe and a cuff in the basket beneath**

![A commercial multi-parameter patient monitor on a rolling stand, showing heart rate, blood pressure, oxygen saturation, respiration and temperature, with electrode leads, a finger probe and a cuff in the basket beneath](/static/images/project/ricky-kids-covid-contact-reference-monitor.jpg)
...
| Metric | Value |
| --- | --- |
| Respiration agreement vs contact reference (guardrail) | ±1.4 (breaths per minute, seated and still) |
| Usable standoff | 1.2 m (agreement collapsed beyond it) |
| Escalation parameters reachable without contact | 0 of 2 (oxygen saturation, blood pressure) |
| Bench sessions — no patients, ever | 24 (6 healthy volunteers) |
...
*Chart: `hbar` · unit % of observed instances*

| Item | Value |
| --- | --- |
| Inside the campus, never near a gate | 62% — nobody is looking here · value: 62 |
| At a gate, stopped | 26% — the part enforcement already sees · value: 26 |
| At a gate, evaded by dropping a rider | 12% — walked in and remounted · value: 12 |

> Timed observation at three entrances and four interior points, Q1 2022. The middle bar is the only one anyone has numbers for, which is why the problem is usually described as smaller than it is — a gate counts the people who fail to avoid it.
...
*Chart: `barsThreshold` · unit % of clips correctly counted*

- Threshold: value 90, label the accuracy we agreed a survey number needs

> Scored against hand labels across 1,840 clips, Q2 2022. Two of four conditions clear the bar. Night is not a degradation, it is a different problem — the model is counting shapes it cannot resolve, and its confidence does not fall to match.
...
- *Shipped:* Motorcycle detection and rider counting; Helmet counting per motorcycle; Per-clip counts written to a survey sheet; Hand-labelled evaluation set and accuracy reporting; Batch scoring of collected survey footage
- *Deferred:* Night and low-light performance; Wider-angle and multi-lane framing; A campus-wide sampling plan
- *Cut:* Number-plate recognition; The offender database and repeat-offender escalation; Automatic notices and fines; Any live camera connection
...
**Screen — The team's system diagram: CCTV feeding a control unit and a database, with notification arrows to registered and non-registered riders' phones**

![The team's system diagram: CCTV feeding a control unit and a database, with notification arrows to registered and non-registered riders' phones](/static/images/project/ricky-kids-triple-riding-system-diagram.jpg)
...
| Metric | Value |
| --- | --- |
| Rider-count agreement with hand labels | 94% (daylight and overcast clips) |
| False-positive rate (guardrail) | 6.2% (two-up flagged as three-up) |
| Identifiers extracted | 0 (no plates, faces or identities) |
| Survey clips scored | 1,840 (hand-labelled against the model) |
| Gate checks defeated by drop-and-remount | 31% (measured at three gates) |
| Time to score the footage | 9 h → 40 min (per survey week) |
...
*Chart: `hbar` · unit % of centres and schools able to buy*

| Item | Value |
| --- | --- |
| Under ₹5,000 | 68% — the target we set, and did not reach · value: 68 |
| ₹5,000 – ₹10,000 | 31% — where the prototype actually landed · value: 31 |
| Above ₹10,000 | 9% — effectively the private-school market · value: 9 |

> Scored against the kinds of institution our teachers worked with, Q3 2021. The bottom bar is why we spent so long on cost: above ten thousand rupees the device stops being an assistive tool and becomes a demonstration piece for the schools that need it least.
...
*Chart: `stackedHBar` · unit criteria, of 14*

| Row | Met | Met with a condition | Not met | Total |
| --- | --- | --- | --- | --- |
| Visual and sound prompts | 12 | 2 | 0 | 12 of 14 |
| Teacher-assigned content | 10 | 3 | 1 | 10 of 14 |
| Guided-writing gantry | 5 | 4 | 5 | 5 of 14 |

> Two teachers, fourteen criteria, three interactions, Q4 2021. The bottom row is the part of the kit we had spent the most time on. Five criteria were not met at all, and four of those five are about what happens when a child wants the device to stop.
...
**Screen — The prototype two-axis gantry: wooden frame, lead screws and linear rails, two stepper motors, and an Arduino with a CNC shield wired to a laptop**

![The prototype two-axis gantry: wooden frame, lead screws and linear rails, two stepper motors, and an Arduino with a CNC shield wired to a laptop](/static/images/project/ricky-kids-autism-toys-gantry.png)
...
> The fourteen criteria grouped into six dimensions and averaged, Q4 2021. The shape is what mattered: the gantry is not uniformly worse, it collapses on two axes. Both are about a child who wants to stop — and no amount of the things we were good at moves either of them.

| Metric | Value |
| --- | --- |
| Sessions with children | 0 (it never went to users) |
| Educator sign-off (guardrail) | 2 of 3 (interactions they would put in front of a child) |
| Reviewers in the design sessions | 2 (special-education teachers) |
| Build cost | ₹10,000 (prototype; target was under ₹5,000) |
...
> **Note.** Sample portfolio page describing a prototype that never went to users. No child took part in any part of this project, no reading or observation of a child appears here, and no clinical, therapeutic or educational-outcome claim is made or implied — the only evidence is two special-education teachers reviewing a bench prototype. What is real: the project, the hardware shown, its team and supervisor, the demonstration at SRM Project Expo on 10 December 2021, and the involvement of teachers from an autism care centre, who are not named. The fourteen criteria, the scores, the price points and every figure are invented and internally reconciled. I'm glad to walk through the real prototype and the real review in a conversation.

---

## 34. Sludge-traversing ROV

*Ricky Kids · 2022 · Field robotics*

**We set out to drive across settled sludge and found there is nothing to drive on — which is why the vehicle in these drawings floats.**
...
*Chart: `hbar` · unit % of line length reachable without entry*

| Item | Value |
| --- | --- |
| Self-propelled vehicle in the line | 71% — works in both directions from a manhole · value: 71 |
| Push-camera on a rod | 34% — as far as a rod will push, one way · value: 34 |
| Floating camera raft | 22% — needs flow, and settled lines have none · value: 22 |

> Scored against manhole spacing on municipal drawings, Q4 2021. The raft scores worst for the reason that matters here: the lines most worth inspecting are the ones that have silted up and stopped flowing, which is exactly when a raft has nothing to ride on.
...
*Chart: `dotplot` · unit mm of sinkage*

| Item | Value |
| --- | --- |
| Fresh sludge analogue | value: 118 · n: 9 |
| Part-settled analogue | value: 74 · n: 9 |
| Settled analogue | value: 31 · n: 9 |

- Threshold: value 60, label track height — above this the tracks touch nothing solid

> Mean sinkage per medium over nine runs each, Q1 2022. Two of the three media bury the tracks entirely. At that point the drive is not gripping anything — it is stirring, and the stirring is what makes the medium thinner still.
...
**Screen — SolidWorks isometric render of the ROV: a transparent cylindrical electronics housing inside a PVC pipe frame, with two large paddle wheels and four ducted thrusters**

![SolidWorks isometric render of the ROV: a transparent cylindrical electronics housing inside a PVC pipe frame, with two large paddle wheels and four ducted thrusters](/static/images/project/ricky-kids-sludge-rov-isometric.jpg)
...
*Chart: `bands` · unit g/cm³*

| Item | Value |
| --- | --- |
| Tracked drive | completed the lane only in the settled analogue · from: 1.15 · to: 1.6 · own: false |
| Paddle wheels and thrusters | the configuration in the drawings above · from: 0.98 · to: 1.3 · own: true |
| Thrusters alone | fine in the fluid regime, stalls once it thickens · from: 0.98 · to: 1.12 · own: false |
| fresh | value: 1.02 |
| part-settled | value: 1.18 |
| settled | value: 1.42 |
...
| Metric | Value |
| --- | --- |
| Density threshold found | 1.15 g/cm³ (traction failed below it) |
| Stalls the vehicle recovered from unaided (guardrail) | 2 of 9 (tracked stalls) |
| Test-lane runs | 27 (3 media × 3 drives × 3 runs) |
| Working standoff from the entry point | 18 m (tether-limited) |
...
## 35. ENVI-City — sustainable smart city concept

*Ricky Kids · 2022 · Urban concept*

**We published a whole-city vision, then cut it down to the one claim we could actually model — and found it holds for housing and not much else.**
...
*Chart: `hbar` · unit % of block resource cost*

| Item | Value |
| --- | --- |
| Power | 54% — any loop that misses this cannot matter · value: 54 |
| Water and wastewater | 31% — where the coupling is physically easiest · value: 31 |
| Solid waste | 15% — small, but it carries the energy content · value: 15 |

> Modelled for a dense residential block, Q4 2021. The split is why we coupled all three rather than picking the tidy pair: waste is the smallest line and the only one that can be turned back into the largest, so leaving it out removes the mechanism the whole idea depends on.
...
| Item | Value |
| --- | --- |
| Claims in the published vision | 11 · value: 11 |
| With a stated mechanism | 7 · value: 7 |
| We could put a number on | 4 · value: 4 |
| Testable at one-block scale | 1 · value: 1 |

> Our own paper, audited against itself in Q1 2022. The drop from eleven to one is the finding before the finding: a vision paper is mostly a list of intentions, and the useful work is deciding which single intention you are prepared to be wrong about in public.
...
**Screen — The team's ICTSGS 2021 conference poster for Envi-city, showing sustainable energy, smart agriculture and smart networking panels with references**

![The team's ICTSGS 2021 conference poster for Envi-city, showing sustainable energy, smart agriculture and smart networking panels with references](/static/images/project/ricky-kids-envi-city-poster.jpg)
...
*Chart: `intervals` · unit % of block resource use*

| Item | Value |
| --- | --- |
| Dense residential | clears, but the range is seven points wide · value: 9 · lo: 2 · hi: 16 · clears: true |
| Mixed residential and retail | the strongest case we found · value: 11 · lo: 4 · hi: 18 · clears: true |
| Commercial | cannot be shown to beat separate utilities · value: 6 · lo: -1 · hi: 13 · clears: false |
| Industrial edge | demand profiles do not overlap in time · value: 3 · lo: -6 · hi: 12 · clears: false |

- Threshold: value 0, label no better than three separate utilities

> Twelve scenarios collapsed to four block types, Q2 2022. The dots are central estimates and the bars are what happens when the assumptions move across the ranges we were willing to defend. Two rows cross the line, which is the honest form of a negative result: not that coupling fails, but that we cannot tell.

| Metric | Value |
| --- | --- |
| Saving from coupling (guardrail) | 9% (dense residential block) |
| Sensitivity of that saving | ±7 pts (across defensible assumptions) |
| Subsystems modelled as one loop | 3 (water, power, waste) |
| Scenarios modelled | 12 (4 block types × 3 climates) |
