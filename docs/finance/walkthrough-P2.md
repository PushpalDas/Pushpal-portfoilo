...
| `/finance/agents` | [finance_watchers.jpg](walkthrough/P2/finance_watchers.jpg) | The contract, the trust ladder (L2 configured, off), "AI is not used for", and each watcher's rules and never-does list; the metric slots say "metrics arrive in phase 3". |
